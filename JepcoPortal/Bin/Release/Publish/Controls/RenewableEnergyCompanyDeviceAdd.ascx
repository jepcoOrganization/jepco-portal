<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RenewableEnergyCompanyDeviceAdd.ascx.cs" Inherits="Controls_RenewableEnergyCompanyDeviceAdd" %>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="row">
                        <div class="col-md-9 col-sm-9">
                            <h3><strong>اضافة جهاز عكس جديد
                            </strong></h3>


                        </div>
                        <div class="col-md-3 pull-right text-right"><a href="javascript:void(0)">عدد أجهزة العكس</a></div>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div style="text-align: center; font-size: 25px; padding: 40px 0;">
                    ...
                    <p>
                        <asp:Literal runat="server" ID="lblInquiryMessage" Text="تم اضافة جهاز عكس جديد بنجاح. سنقوم بمراجعة البيانات واعلامكم في أقرب وقت ممكن.">                             
                        </asp:Literal>
...
<script type="text/javascript">
    ...
    function ClearClick() {
        ...
        $("#fileuploadfield_2").val('');
        $('#fileuploadfield_2').next().html("");

        $("#fileuploadfield_3").val('');
        $('#fileuploadfield_3').next().html("");

        $("#fileuploadfield_4").val('');
        $('#fileuploadfield_4').next().html("");
