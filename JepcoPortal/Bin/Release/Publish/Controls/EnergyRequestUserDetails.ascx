<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EnergyRequestUserDetails.ascx.cs" Inherits="Controls_EnergyRequestUserDetails" %>
<div>
        ...
        <div role="tabpanel" class="tab-pane fade in active" id="Order_details">
            <ul class="list-unstyled">
                ...
                <li>
                    ...
                    <asp:Label ID="lblENGType" runat="server"></asp:Label>
                </li>
                <li>
                    <strong>رقم الطلب / رقم العداد</strong>
                    <%-- <span class="LTR"><b>2798564398222</b></span>--%>
                    <asp:Label ID="lblRefenceNo" runat="server"></asp:Label>
                </li>

                <li id="liMeterStatus" runat="server">
                    <strong>حالة العداد</strong>
                    <%-- <span class="LTR"><b>2798564398222</b></span>--%>
                    <asp:Label ID="lblMeterStus" runat="server"></asp:Label>
                </li>
                ...
                <li>
                    <strong>الرقم المرجعي للطلب</strong>
                    <%-- <span class="LTR"><b>2798564398222</b></span>--%>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtNatinalNo" runat="server" PlaceHolder="رقم هاتف الشركة " disabled="disabled"></asp:TextBox>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="form-group">
                                ...
                                <asp:HyperLink runat="server" ID="lnkSecondNav" NavigateUrl='<%# Bind("DeviceDocument") %>' Target="_blank" class="download">
                                    <strong>
                                        <asp:Label runat="server" ID="lblname" Text='<%# Bind("DeviceName") %>'></asp:Label></strong>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="form-group">
                                ...
                                <asp:HyperLink runat="server" ID="lnkSecondNav" NavigateUrl='<%# Bind("SollarCellDocument") %>' Target="_blank" class="download">
                                    ...
                                    <strong>
                                        <asp:Label runat="server" ID="Label1" Text='<%# Bind("SollarCellName") %>'></asp:Label></strong>
                                    <img src=" <%=ResolveUrl("~/") %>App_Themes/ThemeAr/img/pdf.png" alt="">
                                </asp:HyperLink>
                                <%-- </a>--%>
                            </div>
...
<style>
    @media only screen and (max-width: 1367px) and (min-width: 1300px) {
        .energyrequest_tabcontent li span, .energyrequest_tabcontent li strong, .EnergyRequest_Accordion h5, .time, .date, .EnergyRequest_Accordion p, .EnergyRequest_Accordion strong, .energyrequest_tabcontent label, .energyrequest_tabcontent input, a.download {
            font-size: 13px;
        }
    }
