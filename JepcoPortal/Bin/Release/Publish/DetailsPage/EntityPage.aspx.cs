...
public partial class DetailsPage_EntityPage : SiteBasePage
{
    ...
    protected async void FillData()
    {
        try
        {
            long EntityID = Convert.ToInt64(Page.RouteData.Values["ID"].ToString());
           // int EntityID = 1;
            ...
            Result = await Plugin_FA_EntitiesDomain.GetByID(EntityID);
