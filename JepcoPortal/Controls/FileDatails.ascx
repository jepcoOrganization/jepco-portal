                    ...
                    <td align="center" colspan="3" style="border:solid 0.05vw #0099FF; border-right:none; border-left:none; padding:0px;">
                        <table class="bor" align="center" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                ...
                                <td align="right" colspan="3" width="88%" >
                            ...
                            <tr>
                                <td class="coloreblue" align="right" style="border-left:solid 0.05vw #0099FF; background:#C0DCFE; border-top:solid 0.05vw #0099FF; font-weight: bold" ;=; width="12%">اسم المشترك</td>
                            ...
                            <tr>
                                <td align="right" style="border-left:solid 0.05vw #0099FF; border-top:solid 0.05vw #0099FF; background:#C0DCFE; font-weight: bold" width="13%">قراءة العداد</td>
                                                ...
                                                <table align="center" width="100%" height="100%" style="padding:0px; color:#0044FF" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td height="100%" align="right" style="padding:0;" width="57%">
                                                            <table align="center" width="100%" height="100%" style="padding:0px;" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    <td height="100%" align="center" style="padding:3%; border-left:solid 0.05vw #0099FF;    border-top: solid 0.05vw #0099FF; color:#000000; font-size:130%;font-weight: bold" width="35%" id="unClearingAmount_fils"></td>
...
<script>
    ...
    $("document").ready(function () {
                        ...
                        $.each(AllBills, function (key, value) {
                            ...
                            if (value.ibillingQuantity > 0) {
                                if (value.clearingDate !== "0000/00/00") {
                                    ...
                                    FileData.subsidy_Flag = value.subsidy_Flag;
        ...
        $(document).on('click', '.showBillModal', function (event) {
            ...
            if (selectedInvoce.subsidy_Flag == "") {
...
.divBillModal .modal-content {
    ...
    .divBillModal .modal-body {
        padding: 0px 30px;
    }
        .divBillModal .modal-header {
            padding: 8px 15px;
        }
    }
