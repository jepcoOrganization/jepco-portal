...
{
    [DataContract]
    public class RenewableEnergyUserRequestsDetailsEntity
    {
        [DataMember] public long        DetailsID       { get; set; }
        [DataMember] public long        UserRequestID   { get; set; }
        [DataMember] public int         EnergyType      { get; set; }        
        [DataMember] public string      EnergyTypeOther { get; set; }
        [DataMember] public int         PowerType       { get; set; }
