...
{
    public partial class ManageAudioAlbum : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    {
                        Session["AudioAlbumIDSession"] = null;
                        FillNavigation();
                        FillData();
                    }
                    else
        ...
        protected async void FillData()
        {
            ...
            Result = await PluginAlbumDomain.GetAlbumByType(2);
        ...
        protected void lstPages_ItemCommand(object sender, ListViewCommandEventArgs e)
        {
            if (e.CommandName == "ViewEdit")
            {
                ...
                Response.Redirect("~/Media/AudioAlbum/EditAudioAlbum.aspx", false);
            }
        ...
        {
            Response.Redirect("~/Media/AudioAlbum/AddAudioAlbum.aspx", false);
        }
