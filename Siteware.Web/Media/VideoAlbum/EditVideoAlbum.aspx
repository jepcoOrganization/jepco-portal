<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditVideoAlbum.aspx.cs" Inherits="Siteware.Web.Pages.EditVideoAlbum" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        <ul class="breadcrumbs">
            ...
            <li><a href="../Banner/ManageBanner.aspx">Video Ablum List</a> <span class="separator"></span></li>
            <li>Edit Video Ablum
                    ...
                    <div class="col-lg-8" style="width: 100%;">
                        <div class="widgetbox personal-information">
                            <div class="tabbedwidget tab-primary" style="min-height: 385px;">
                                <ul>
                                    <li><a href="#a-1" style="font-size: 14px;">Video Ablum Information</a></li>
                                    <li><a href="#a-2" style="font-size: 14px;">SEO Attributes</a></li>
                                    <li><a href="#a-3" style="font-size: 14px;">Video Ablum Image </a></li>
                                </ul>
                                <br />
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">Video Ablum Information Update Sucessfully</div>
            <div id="popup_panel">
