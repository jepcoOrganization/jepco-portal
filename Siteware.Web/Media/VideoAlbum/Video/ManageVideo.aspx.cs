...
namespace Siteware.Web.Pages
{
    public partial class ManageVideo : System.Web.UI.Page
    {
        ...
        protected async void FillData()
        {
            ...
            Result = await PluginAlbumDetailDomain.GetAlbumByAlbumID(Convert.ToInt32(Session["VideoAlbumIDSession"].ToString()));
        ...
        protected void lstPages_ItemCommand(object sender, ListViewCommandEventArgs e)
        {
            if (e.CommandName == "ViewEdit")
            {
                ...
                Session["VideoIDSession"] = ID;

                Response.Redirect("~/Media/VideoAlbum/Video/EditVideo.aspx", false);
            }
        ...
        {
            Response.Redirect("~/Media/VideoAlbum/Video/AddVideo.aspx", false);
        }
