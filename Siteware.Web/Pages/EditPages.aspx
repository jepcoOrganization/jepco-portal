<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditPages.aspx.cs" Inherits="Siteware.Web.Pages.EditPages" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="col-lg-8" style="width: 100%;">
                        <div class="widgetbox personal-information">
                            <div class="tabbedwidget tab-primary" style="min-height: 330px;">
                                <ul>
                                    <li><a href="#a-1" style="font-size: 14px;">Page Information</a></li>
                                    <li><a href="#a-2" style="font-size: 14px;">SEO Attributes</a></li>
                                    <li><a href="#a-3" style="font-size: 14px;">Content</a></li>
                                    <li><a href="#a-7" class="clickMeta" style="font-size: 14px;">Content1</a></li>
                                    <li><a href="#a-4" style="font-size: 14px;display:none;">Page Image </a></li>
                                ...
                                <div id="a-1" style="min-height: 283px;">
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <div class="col-md-10" style="width: 22%;">
                                            <asp:Label ID="lblPageCount" runat="server" Style="position: relative; top: 5px;"></asp:Label>
                                            <asp:Label ID="lblPageLanguageId" Visible="false" runat="server" Style="position: relative; top: 5px;"></asp:Label>
                                        </div>
                                    </div>
                                    <div class="form-group" style="height: 42px">
                                    ...
                                    <div class="form-group" id="divpageurl" runat="server" style="height: 42px">
                                        ...
                                        <div class="col-md-10" style="width: 88%;">
                                            <asp:TextBox ID="txtAliasPath" runat="server" PlaceHolder="Alias Path" class="form-control" Style="width: 23.5%; float: left;"></asp:TextBox>
                                            &nbsp&nbsp&nbsp&nbsp
                                            <asp:Label ID="lblAliasPath" runat="server" Style="position: relative; top: 7px;"></asp:Label>
                                        </div>
                                    </div>
                                    <div class="form-group" id="div1" runat="server" style="height: 42px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 11%; padding-left: 1.2%;">Name Path:</label>
                                        <div class="col-md-10" style="width: 88%;">
                                            <asp:TextBox ID="txtNamePath" runat="server" PlaceHolder="Name Path" class="form-control" Style="width: 23.5%; float: left;"></asp:TextBox>
                                            &nbsp&nbsp&nbsp&nbsp
                                            <asp:Label ID="lblNamePath" runat="server" Style="position: relative; top: 7px;"></asp:Label>
                                        </div>
                                    </div>
                                    <div class="form-group" id="div2" runat="server" style="height: 42px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 11%; padding-left: 1.2%;">Live Path:</label>
                                        <div class="col-md-10" style="width: 62%;">
                                            <asp:HyperLink runat="server" ID="lnklblLivePath" Target="_blank">
                                                <asp:Label ID="lblLivePath" runat="server" Style="position: relative; top: 7px;"></asp:Label>
                                            </asp:HyperLink>
                                        </div>
                                    </div>
                                ...
                                <div id="a-2" style="min-height: 313px;">
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <div class="col-md-10" style="width: 30%;">
                                            <asp:TextBox ID="txtMetaDescription" runat="server" PlaceHolder="Page URL" class="form-control" Style="width: 90%; float: left"></asp:TextBox>
                                            <div id="popovers" style="width: 10%; float: right;">
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">Page Information Update Sucessfully</div>
            <div id="popup_panel">
