<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.Master" CodeBehind="AddDailyAdvise.aspx.cs" Inherits="Siteware.Web.Plugins.DailyAdvise.AddDailyAdvise" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <div class="tabbedwidget tab-primary" style="min-height: 330px;">
                                ...
                                <div id="a-1" style="min-height: 283px;">
                                    ...
                                    <div class="form-group" style="height: 125px">
                                        ...
                                        <div class="col-md-10" style="width: 22.9%;">
                                            <asp:TextBox ID="txtSummary" runat="server" PlaceHolder="Summary" Style="width: 273px;" class="form-control" TextMode="MultiLine" Rows="6"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group" style="height: 42px">
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">Daily Advise Information Add Sucessfully</div>
            <div id="popup_panel">
