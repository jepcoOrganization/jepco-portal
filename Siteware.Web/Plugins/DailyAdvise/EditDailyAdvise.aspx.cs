...
{
    public partial class EditDailyAdvise : System.Web.UI.Page
    {
        ...
        protected async void FillDetails()
        {
            ...
            {
                int ID = Convert.ToInt32(Session["AdviseIDSession"]);

                ResultEntity<Plugin_DailyAdviseEntity> Result = new ResultEntity<Plugin_DailyAdviseEntity>();

                Result = await Plugin_DailyAdviseDomain.GetByID(ID);
        ...
        protected async void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (Session["AdviseIDSession"] != null)
            {
                entity.AdviseID = Convert.ToInt32(Session["AdviseIDSession"]);
                ...
                var Result = await Plugin_DailyAdviseDomain.Update(entity);
                if (Result.Status == ErrorEnums.Success)
                {
                    mpeSuccess.Show();
                }
