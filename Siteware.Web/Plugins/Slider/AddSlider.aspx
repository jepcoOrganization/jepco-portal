<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AddSlider.aspx.cs" Inherits="Siteware.Web.Pages.AddSlider" Async="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="../../AppTheme/ScriptImageUpload/dropzone.css" rel="stylesheet" />
    <script src="../../AppTheme/ScriptImageUpload/dropzone.js"></script>
    <%--<script src="../..../../AppTheme/ScriptImageUpload/jquery.min.js"></script>--%> 
    <script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        <ul class="breadcrumbs">
            ...
            <li><a href="../Slider/ManageSlider.aspx">Slider</a> <span class="separator"></span></li>
            <li>Add Slider</li>           
        </ul> 
        <div class="pageheader">
            <asp:Button ID="btnAdd2" runat="server" Text="Save" class="btn btn-primary" ValidationGroup="s1" OnClick="BtnAdd_Click"
                    ...
                    <div class="col-lg-8" style="width: 100%;">
                        <div class="widgetbox personal-information">
                            <div class="tabbedwidget tab-primary" style="min-height: 330px;">
                                <ul>
                                    <li><a href="#a-1" style="font-size: 14px;">Slider Information</a></li>
                                    <li><a href="#a-2" style="font-size: 14px;">SEO Attributes</a></li>
                                     <li><a href="#a-4" style="font-size: 14px;"> Silder Content</a></li>
                                    <li><a href="#a-3" style="font-size: 14px;"> Silder Image</a></li>
                                </ul>
                                <br />
                                <div id="a-1" style="min-height: 283px;">
                                     <div class="form-group" style="height: 42px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 15%; padding-left: 1.2%;">Select Slider Language:</label>
                                        <div class="col-md-10" style="width: 22.9%;">
                                             <asp:DropDownList ID="ddlLanguages" runat="server" class="chzn-select" TabIndex="2" Width="100%" style="width: 273px;">
                                            </asp:DropDownList>
                                        </div>
                                         <asp:RequiredFieldValidator runat="server" style="margin: 70px;" InitialValue="0" ErrorMessage="Please Select Language" ID="validLang"
                                            ControlToValidate="ddlLanguages" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="s1" EnableClientScript="True" />
                                    </div>
                                    ...
                                    <div class="form-group" style="height:42px">
                                        ...
                                        <%-- <asp:RequiredFieldValidator runat="server" style="margin: 70px;" ErrorMessage="Please Select Language" ID="RequiredFieldValidator1"
                                            ControlToValidate="txtPageName" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="s1" EnableClientScript="True" />--%>
                                    </div>
                                     <div class="form-group" style="height:61px;display:none;">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 15%; padding-left: 1.2%;">Link Summary:</label>
                                        <div class="col-md-10" style="width: 22.9%;">
                                            <asp:TextBox ID="txtSammery" runat="server" PlaceHolder="Link Label" TextMode="MultiLine" style="width: 273px;"  class="form-control"></asp:TextBox>
                                        </div>
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <div class="col-md-10" style="width: 22.9%;">
                                            <asp:TextBox ID="txtLink" runat="server" PlaceHolder="Link" Style="width: 273px;" class="form-control"></asp:TextBox>
                                        </div>
                                        <%-- <asp:RequiredFieldValidator runat="server" style="margin: 70px;"  ErrorMessage="Please Select Language" ID="RequiredFieldValidator2"
                                            ControlToValidate="txtLink" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="s1" EnableClientScript="True" />--%>
                                    </div>
                                    <div class="form-group" style="height:42px">
                                        ...
                                        <div class="col-md-10" style="width: 22%;">
                                            <asp:DropDownList ID="ddlParentPage" runat="server" class="chzn-select" style="width: 273px;"  TabIndex="2" Width="100%">
                                      ...
                                      <div class="form-group" style="height: 42px">
                                        ...
                                        <div class="col-md-10" style="width: 22.9%;">
                                            <asp:TextBox ID="txtOredr" runat="server" PlaceHolder="Order" Style="width: 273px;" class="input-spinner" ></asp:TextBox>
                                       
                                        </div>
                                          <asp:RequiredFieldValidator runat="server" ErrorMessage="Required Field" style="margin: 70px;" ID="RequiredFieldValidator4"
                                            ControlToValidate="txtOredr" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="s1" EnableClientScript="True" />
                                          <asp:RegularExpressionValidator ID="RegularExpressionValidator1" Style="left: 3%;position: relative;color: red;" ValidationGroup="s1" ControlToValidate="txtOredr" runat="server" ErrorMessage="Only Numbers allowed" ValidationExpression="\d+">
                                          </asp:RegularExpressionValidator>
                                    </div>  
                                     <div class="form-group" style="height: 42px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 15%; padding-left: 1.2%;">Is Publish:</label>
                                        <div class="col-md-10" style="width: 22.9%;">
                                            <asp:CheckBox ID="CBIsPublish" runat="server" CssClass="checker" Style="position: relative; top: 4px;" />
                                        </div>
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ValidationGroup="s1"
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ErrorMessage="Please Fill Date" ID="RequiredFieldValidator3"
                                            ControlToValidate="txtPublishDate" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="s1" EnableClientScript="True" />
                                    </div>
                                     <asp:RequiredFieldValidator runat="server" style="margin: 70px;" ErrorMessage="Please Select Language" ID="RequiredFieldValidator5"
                                            ControlToValidate="txtPublishDate" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="s1" EnableClientScript="True" />
                                </div>
...
<%--                        <br />
                        ...
                        <p style="text-align: right;">
                            <asp:Button ID="BtnAdd" runat="server" Text="Save" class="btn btn-primary" ValidationGroup="s1" OnClick="BtnAdd_Click"/>
                        </p>
                    </div>
                </div>
    ...
    <div id="popup_container" class="ui-draggable" style="display:none;position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;"> Slider Information Add Sucessfully</div>
            <div id="popup_panel">
