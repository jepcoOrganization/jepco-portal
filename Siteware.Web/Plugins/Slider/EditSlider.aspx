<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditSlider.aspx.cs" Inherits="Siteware.Web.Pages.EditSlider" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        ...
        <div class="pageheader">
            <asp:Button ID="btnUpdate2" runat="server" Text="Save" class="btn btn-primary" ValidationGroup="s2" OnClick="btnUpdate_Click"
                ...
                <div class="row">
                    <div class="col-lg-8" style="width: 100%;">
                        <div class="widgetbox personal-information">
                            <div class="tabbedwidget tab-primary" style="min-height: 330px;">
                                <ul>
                                    ...
                                    <li><a href="#a-4" style="font-size: 14px;">Slider Content</a></li>
                                    <li><a href="#a-3" style="font-size: 14px;">Slider Image</a></li>
                                </ul>
                                <br />
                                <div id="a-1" style="min-height: 283px;">
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" Style="margin: 70px;" InitialValue="0" ErrorMessage="Please Select Language" ID="validLang"
                                            ControlToValidate="ddLanguages" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="s2" EnableClientScript="True" />
                                    </div>
                                    <div class="form-group" style="height: 42px">
                                       ...
                                       <%-- <asp:RequiredFieldValidator runat="server" style="margin: 70px;" ErrorMessage="Please Select Language" ID="RequiredFieldValidator5"
                                            ControlToValidate="txtPageName" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="s2" EnableClientScript="True" />--%>
                                    </div>
                                    ...
                                    <div class="form-group" style="height: 42px">
                                      ...
                                      <%--  <asp:RequiredFieldValidator runat="server" style="margin: 70px;" ErrorMessage="Please Select Language" ID="RequiredFieldValidator1"
                                            ControlToValidate="txtLink" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="s2" EnableClientScript="True" />--%>
                                    </div>
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <div class="col-md-10" style="width: 22%;">
                                            <asp:DropDownList ID="ddlTarget" runat="server" class="chzn-select" Style="width: 273px;" TabIndex="2" Width="100%">
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ErrorMessage="Required Field" Style="margin: 70px;" ID="RequiredFieldValidator4"
                                            ControlToValidate="txtOredr" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="s2" EnableClientScript="True" />
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" Style="left: 3%; position: relative; color: red;" ValidationGroup="s2"
                                            ControlToValidate="txtOredr" runat="server" ErrorMessage="Only Numbers allowed" ValidationExpression="\d+">
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ValidationGroup="s2"
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ErrorMessage="Please Fill Date" ID="RequiredFieldValidator2"
                                            ControlToValidate="txtPublishDate" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="s2" EnableClientScript="True" />
                                    </div>
                                </div>
                                <div id="a-2" style="min-height: 283px;">
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <div class="col-md-10" style="width: 30%;">
                                            <asp:TextBox ID="txtMetaDescription" runat="server" PlaceHolder="Image Alternate" class="form-control" Style="width: 90%; float: left; width: 273px"></asp:TextBox>
                                            <%-- <div id="popovers" style="width: 10%; float: right;">
                        ...
                        <p style="text-align: right;">
                            <asp:Button ID="btnUpdate" runat="server" Text="Save" class="btn btn-primary" ValidationGroup="s2" OnClick="btnUpdate_Click" />
                        </p>
                    </div>
                </div>
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">Slider Information Update Sucessfully</div>
            <div id="popup_panel">
