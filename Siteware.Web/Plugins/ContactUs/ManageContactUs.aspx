<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageContactUs.aspx.cs" Inherits="Siteware.Web.Pages.ManageContactUs" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        ...
        <div class="pageheader">
            <div>
                <asp:LinkButton ID="BtnDelete2" runat="server" class="btn btn-primary" Text="Delete Contact Us" OnClick="Delete_Click"
                    Style="position: relative; float: right; top: 31px; color: white">
                    <span class="glyphicon glyphicon-remove" style="color:white;padding-right: 4%;"></span> Delete Contact Us
                </asp:LinkButton>
         <%--       <asp:LinkButton ID="BtnPDF2" runat="server" class="btn btn-danger" Text="Export to PDF"
                ...
                <asp:LinkButton ID="btnAdd2" runat="server" class="btn btn-primary" Text="Add Contact Us" OnClick="btnAdd_Click"
                    Style="position: relative; float: right; top: 31px; right: 0.5%; color: white">
                    <span class="glyphicon glyphicon-plus" style="color:white;padding-right: 4%;"></span> Add Contact Us
                </asp:LinkButton>
            </div>
                                        ...
                                        <table id="mytbl" class="table table-striped table-bordered table-hover dataTables-example">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="head1">Contact Us ID</th>
                                                    <th class="head2">Contact Us name</th>
                                                    <th class="head3">Language</th>  
                                                    <th class="head4">Action</th>
                                                </tr>
                                            </thead>
                                            <tbody>
    ...
    <script>
        ...
        $(document).ready(function () {
           ...
           $.ajax({
               ...
               url: "ManageContactUs.aspx/BindDatatoDropdown",
               data: "{}",
               dataType: "json",
               async: true,
