<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageNews.aspx.cs" Inherits="Siteware.Web.Plugins.News.ManageNews" Async="true" %>
                                        ...
                                        <table id="mytbl" class="table table-striped table-bordered table-hover dataTables-example">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="head1">News ID</th>
                                                    <th class="head2">HeadLine</th>
                                                    <th class="head3">News Date</th>
                                            ...
                                            <tbody>
                                                <asp:ListView ID="lstNews" runat="server" OnItemDataBound="lstNews_ItemDataBound" OnItemCommand="lstNews_ItemCommand">
                                                    <ItemTemplate>
                                                        <tr class="gradeX">
                                                            <td class="aligncenter">
                                                                <span class="center">
                                                                    <asp:CheckBox ID="CBID" runat="server" />
                                                                    <asp:Label ID="lblID" runat="server" Text='<%# Bind("NewsID") %>' Visible="false"></asp:Label>
                                                                </span>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td class="center">
                                                                <asp:Label ID="lblNewsOrder" runat="server" Text='<%# Bind("NewsOrder") %>'></asp:Label>
                                                            </td>
                                                            <td class="center">
                                                            ...
                                                            <td class="center">
                                                                <asp:Label ID="lblViewCount" runat="server" Text='<%# Bind("ViewCount") %>'></asp:Label>
                                                            </td>
