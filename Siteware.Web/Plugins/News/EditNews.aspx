<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditNews.aspx.cs" Inherits="Siteware.Web.Plugins.News.EditNews" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        <ul class="breadcrumbs">
            ...
            <li><a href="../News/ManageNews.aspx">News List</a> <span class="separator"></span></li>
            <li>Edit
                        ...
                        <div class="widgetbox personal-information">
                            <div class="tabbedwidget tab-primary" style="min-height: 330px;">
                                <ul>
                                    ...
                                    <li id="HeadlineImage" runat="server"><a href="#a-3" style="font-size: 14px;">Headline Image</a></li>
                                    <li><a href="#a-4" style="font-size: 14px;">Map News</a></li>
                                </ul>
                                <div id="a-1" style="min-height: 283px;">
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <div class="col-md-10" style="width: 22.9%;">
                                            <asp:DropDownList ID="ddNewsLanguages" runat="server" class="chzn-select" TabIndex="2" Style="width: 203px;" OnSelectedIndexChanged="ddNewsLanguages_SelectedIndexChanged" AutoPostBack="true">
                                            </asp:DropDownList>
                                        </div>
                                        <asp:RequiredFieldValidator runat="server" InitialValue="0" ErrorMessage="Please Select Language" ID="validLang"
                                            ControlToValidate="ddNewsLanguages" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="1" EnableClientScript="True" />
                                    </div>
                                    <div class="form-group" style="height: 42px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 11%; padding-left: 1.2%;">HeadLine:</label>
                                        <div class="col-md-10" style="width: 22.9%;">
                                            <asp:TextBox ID="txtHeadLine" runat="server" PlaceHolder="HeadLine" class="form-control"></asp:TextBox>
                                        </div>
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 11%; padding-left: 1.2%;">News Date:</label>
                                        <div class="col-md-10" style="width: 22.9%;">
                                            <input id="txtNewDate" runat="server" type="text" placeholder="mm/dd/yyyy" name="date" class="Dateeee form-control" />
                                        </div>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ValidationGroup="1"
                                            ErrorMessage="Please enter date in mm/dd/yyyy format" ControlToValidate="txtNewDate" ForeColor="Red"
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ErrorMessage="Please Fill Date" ID="RequiredFieldValidator4"
                                            ControlToValidate="txtNewDate" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="1" EnableClientScript="True" />
                                    </div>
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 11%; padding-left: 1.2%;">Shwo In Marquee:</label>
                                        <div class="col-md-10" style="width: 22%;">
                                            <asp:CheckBox ID="CBShowInMarquee" runat="server" Style="position: relative; top: 4px;" />
                                        </div>
                                    </div>
                                    <div class="form-group" style="height: 42px">
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 11%; padding-left: 1.2%;">Is Notification:</label>
                                        <div class="col-md-10" style="width: 23%;">
                                            <asp:CheckBox ID="CBIsNotification" runat="server" Style="position: relative; top: 4px;" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="a-4" style="min-height: 283px;">
                                    <div class="form-group" style="height: 42px">
                                        <%--<label class="col-md-2 control-label" style="text-align: left; width: 11%; padding-left: 1.2%;">
                                        Map News:
                                        </label>--%>
                                        <asp:Label runat="server" class="col-md-2 control-label" ID="lblMapNews1" Style="text-align: left; width: 15%; padding-left: 1.2%; font-weight: bold">
                                            Map News:
                                        </asp:Label>
                                        <div class="col-md-10" style="width: 45%;">
                                            <asp:DropDownList ID="ddlMappedNews1" runat="server" class="chzn-select" TabIndex="2" Width="100%">
                                            </asp:DropDownList>
                                        </div>
                                        <%--<asp:RequiredFieldValidator runat="server" InitialValue="0" ErrorMessage="Please Select Language" ID="RequiredFieldValidator3"
                                            ControlToValidate="ddlMappedNews1" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="1" EnableClientScript="True" />--%>
                                    </div>
                                    <%--<label class="col-md-2 control-label" style="text-align: left; width: 11%; padding-left: 1.2%;"></label>--%>
                                    <asp:Label runat="server" class="col-md-2 control-label" ID="lblMapNews2" Style="text-align: left; width: 15%; padding-left: 1.2%; font-weight: bold; visibility: hidden;">
                                            Map News:
                                    </asp:Label>
                                    <div class="col-md-10" style="width: 45%; visibility: hidden;">
                                        <asp:DropDownList ID="ddlMappedNews2" runat="server" class="chzn-select" TabIndex="2" Width="100%">
                                        </asp:DropDownList>
                                    </div>
                                    <%--<asp:RequiredFieldValidator runat="server" InitialValue="0" ErrorMessage="Please Select Language" ID="RequiredFieldValidator5"
                                        ControlToValidate="ddlMappedNews2" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="1" EnableClientScript="True" />--%>
                                </div>
                            </div>
                        </div>
                        <br />
