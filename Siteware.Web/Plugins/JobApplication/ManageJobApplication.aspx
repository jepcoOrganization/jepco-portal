<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageJobApplication.aspx.cs" Inherits="Siteware.Web.Plugins.JobApplication.ManageJobApplication" Async="true" %>
                                        ...
                                        <table id="mytbl" class="table table-striped table-bordered table-hover dataTables-example">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="head1">JobApplication ID</th>
                                                    <th class="head2">First Name</th>
                                                    <th class="head3">Birth Date</th>
                                                ...
                                                <asp:ListView ID="lstdata" runat="server" OnItemDataBound="lstdata_ItemDataBound" OnItemCommand="lstdata_ItemCommand">
                                                    <ItemTemplate>
                                                        <tr class="gradeX">
                                                            ...
                                                            <td>
                                                                <asp:Label ID="lblJobApplicationID" runat="server" Text='<%# Bind("JobApplicationID") %>'></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lblFirstName" runat="server" Text='<%# Bind("FirstName") %>'></asp:Label>
                                                            </td>
                                                            <td class="center">
                                                                <asp:Label ID="lblDates" runat="server" Text='<%# Bind("BirthDate") %>'></asp:Label>
                                                            </td>
                                                            <td class="center">
                                                            ...
                                                            <td class="center">&nbsp;
                                    <asp:LinkButton ID="lnkEdit" runat="server" CommandName="ViewEdit" CommandArgument='<%# Bind("JobApplicationID") %>'  ToolTip="View Data">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                url: "ManageJobApplication.aspx/BindDatatoDropdown",
                data: "{}",
                dataType: "json",
                async: true,
