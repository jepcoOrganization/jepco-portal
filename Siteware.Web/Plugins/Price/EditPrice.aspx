<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.Master" CodeBehind="EditPrice.aspx.cs" Inherits="Siteware.Web.Plugins.Price.EditPrice" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        <ul class="breadcrumbs">
            ...
            <li><a href="../Price/ManagePrices.aspx">Price List</a> <span class="separator"></span></li>
            <li>Edit Price
                    ...
                    <div class="col-lg-8" style="width: 100%;">
                        <div class="widgetbox personal-information">
                            <div class="tabbedwidget tab-primary" style="min-height: 330px;">
                                <ul>
                                    <li><a href="#a-1" style="font-size: 14px;">Price Information</a></li>
                                    <li><a href="#a-2" style="font-size: 14px;">Prices Content</a></li>
                                </ul>
                                <br />
                               <div id="a-1" style="min-height: 283px;">
                                ...
                                <div id="a-2" style="min-height: 283px;">
                                    <CKEditor:CKEditorControl ID="txtPriceContent" runat="server"></CKEditor:CKEditorControl>
                                </div>
                            </div>
                        </div>
                        <br />
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">Price Information Update Sucessfully</div>
            <div id="popup_panel">
