<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageServiceTab.aspx.cs" Inherits="Siteware.Web.Plugins.ServiceTab.ManageServiceTab" Async="true"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="pageheader">
            <div>
                <asp:LinkButton ID="BtnDelete2" runat="server" class="btn btn-primary" Text="Delete Page" OnClick="BtnDelete2_Click"
                    ...
                    <span class="glyphicon glyphicon-remove" style="color:white;padding-right: 4%;"></span> Delete ServiceTab
                </asp:LinkButton>
                ...
                <asp:LinkButton ID="btnAdd2" runat="server" class="btn btn-primary" Text="Add Pages" OnClick="btnAdd2_Click"
                    Style="position: relative; float: right; top: 31px; right: 0.5%; color: white">
                    <span class="glyphicon glyphicon-plus" style="color:white;padding-right: 4%;"></span> Add ServiceTab
                </asp:LinkButton>
            </div>
            ...
            <div class="pagetitle">
                ...
                <h1>ServiceTab List</h1>
            </div>
        </div>

        <div class="maincontent">
            <div class="maincontentinner">
                <h4 class="widgettitle">Service Tab</h4>
                                        ...
                                        <table id="mytbl" class="table table-striped table-bordered table-hover dataTables-example">
                                            ...
                                            <thead>
                                                <tr>
                                                   ...
                                                   <%-- <th class="head3" hidden>Entity Name</th> --%>                                                                                                      
                                            ...
                                            <tbody>
                                                <asp:ListView ID="lstDataPoint" runat="server" OnItemDataBound="lstDataPoint_ItemDataBound" OnItemCommand="lstDataPoint_ItemCommand">
                                                    <ItemTemplate>
                                                        <tr class="gradeX">
                                                            ...
                                                            <td>
                                                                <asp:Label ID="lblAnnouncementID" runat="server" Text='<%# Bind("ID") %>'></asp:Label>
                                                            </td>
                                                            <td>
                                                           ...
                                                           <%-- <td class="center" hidden>
                                                            ...
                                                            <td class="center">&nbsp;
                                    <asp:LinkButton ID="lnkEdit" runat="server" CommandName="ViewEdit" CommandArgument='<%# Eval("ID") %>' ToolTip="Edit ServiceTab">
                                        <span class="glyphicon iconsweets-create"></span>
                                    </asp:LinkButton>
                                                                &nbsp;
                                    <asp:LinkButton ID="lnkDelete" runat="server" CommandName="DeleteItem" CommandArgument='<%# Eval("ID") %>' ToolTip="Delete ServiceTab">
    ...
    <%--     <script src="../../AppTheme/ScriptDataTable/jquery-2.1.1.js"></script>--%>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                url: "ManageServiceTab.aspx/BindDatatoDropdown",
                data: "{}",
                dataType: "json",
                async: true,
