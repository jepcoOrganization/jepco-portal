<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageInquiry.aspx.cs" Inherits="Siteware.Web.Plugins.Inquiry.ManageInquiry" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="pageheader">
            <div>
                <asp:LinkButton ID="BtnDelete2" runat="server" class="btn btn-primary" Text="Delete Page" OnClick="BtnDelete2_Click"
                    ...
                    <span class="glyphicon glyphicon-remove" style="color:white;padding-right: 4%;"></span> Delete Inquiries
                </asp:LinkButton>
             <%--   <asp:LinkButton ID="BtnPDF2" runat="server" class="btn btn-danger" Text="Export to PDF"
                ...
                <%--<asp:LinkButton ID="btnAdd2" runat="server" class="btn btn-primary" Text="Add Pages" OnClick="btnAdd2_Click"
                    Style="position: relative; float: right; top: 31px; right: 0.5%; color: white">
                    <span class="glyphicon glyphicon-plus" style="color:white;padding-right: 4%;"></span> Add Inquiry
                </asp:LinkButton>--%>
            </div>
                            ...
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    <div class="table-responsive">
                                        <table id="dtInquiry" class="table table-striped table-bordered table-hover dataTables-example">
                                            <colgroup>
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="head2">Interest</th>
                                                    <th class="head1">Message</th>                                                                                                         
                                                    <th class="head1">Inquiry Date</th>
                                                    <th class="head1">Action</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <asp:ListView ID="lstInquiry" runat="server" OnItemDataBound="lstInquiry_ItemDataBound" OnItemCommand="lstInquiry_ItemCommand">
                                                    <ItemTemplate>
                                                        <tr class="gradeX">
                                                            <td class="aligncenter">   
                                                                <span class="center">
                                                                    <asp:CheckBox ID="CBID" CssClass="mycheckbox" runat="server" />
                                                                    <asp:Label ID="lblID" runat="server" Text='<%# Bind("ID") %>' Visible="false"></asp:Label>
                                                                </span>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lblInquiryID" runat="server" Text='<%# Bind("ID") %>'></asp:Label>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td class="center">
                                                                <asp:Label ID="lblInquiryDate" runat="server" Text='<%# Bind("AddDate") %>'></asp:Label>
                                                            </td>

                                                            <td class="center"><%--&nbsp;
                                    <asp:LinkButton ID="lnkEdit" runat="server" CommandName="ViewEdit" CommandArgument='<%# Eval("ID") %>' ToolTip="Edit New">
    ...
    <script>
        ...
        $('#selectAll').click(function (e) {
            ...
            $(".mycheckbox:checked", oTable.fnGetNodes()).each(function () {
        ...
        $(document).ready(function () {
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    //{ extend: 'copy' },
                    //{ extend: 'csv' },
                    { extend: 'excel', title: 'Inquiry', text: '<span class="glyphicon glyphicon-file" style="color:white;padding-right: 4%;"></span> Export to Excel', className: 'btn btn-success btn-Excel', titleAttr: 'Excel' },
                    { extend: 'pdf', title: 'Inquiry', text: '<span class="glyphicon glyphicon-file" style="color:white;padding-right: 4%;"></span> Export to PDF', className: 'btn btn-success btn-PDF', titleAttr: 'PDF' },
                     {
                         extend: 'print', title: 'Inquiry', text: '<span class="glyphicon glyphicon-file" style="color:white;padding-right: 4%;"></span> Print', className: 'btn btn-success btn-Print', titleAttr: 'Print',
        ...
        var rowcollection = oTable.$(".mycheckbox:checked", { "page": "all" });
