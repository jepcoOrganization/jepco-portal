...
{
    public partial class AddSubFinancePerformance : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    if (SessionManager.GetInstance.Users != null)
                    {
                        ...
                        {
                            lblLanguageID.Value = Session["FinanceLanguageID"].ToString();
                            HDFinanceID.Value = Session["FinanceIDSession"].ToString();
                        }
                       // FillLanguages();
                    }
                    else
