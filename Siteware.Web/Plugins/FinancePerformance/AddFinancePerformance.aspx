<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.Master" CodeBehind="AddFinancePerformance.aspx.cs" Inherits="Siteware.Web.Plugins.FinancePerformance.AddFinancePerformance" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        <ul class="breadcrumbs">
            ...
            <li><a href="../FinancePerformance/ManageFinancePerformance.aspx">Finance Performance List</a> <span class="separator"></span></li>
            <li>Add Finance Performance</li>
        </ul>
                                ...
                                <br />
                                    <div id="a-1" style="min-height: 283px;">
                                        ...
                                        <div class="col-md-10" style="width: 22.9%;">
                                            <asp:DropDownList ID="ddlLanguages" runat="server" class="chzn-select" TabIndex="2" Style="width: 273px;">
                                                <%--AutoPostBack="true" OnSelectedIndexChanged="ddlLanguages_SelectedIndexChanged"--%>
                                            </asp:DropDownList>
                                        </div>
                                        <asp:RequiredFieldValidator runat="server" InitialValue="0" ErrorMessage="Please Select Language" ID="RequiredFieldValidator8"
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">Finance Performance Information Add Sucessfully</div>
            <div id="popup_panel">
