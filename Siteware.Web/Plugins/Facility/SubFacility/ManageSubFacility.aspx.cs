...
{
    public partial class ManageSubFacility : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("~/Plugins/Facility/SubFacility/AddSubFacility.aspx", false);
        }
        ...
        protected void lstFacility_ItemCommand1(object sender, ListViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "ViewEdit")
                {
                    ...
                    Response.Redirect("~/Plugins/Facility/SubFacility/EditSubFacility.aspx", false);
                }
