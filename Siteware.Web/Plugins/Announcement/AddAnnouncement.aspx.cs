...
namespace Siteware.Web.Plugins.Announcement
{
    public partial class AddAnnouncement : System.Web.UI.Page
    {
        ...
        protected void lnkFileUpload_Click(object sender, EventArgs e)
        {
            ...
            HeadlineVideo.Attributes.Add("class", "ui-tabs-active ui-state-active");
        }
        ...
        protected async void btnAdd2_Click(object sender, EventArgs e)
        {
            ...
            entity.VideoType = Convert.ToInt32(ddchoisLink.SelectedValue);
            ...
            // entity.AnnouncementDate = DateTime.ParseExact(datetime, "MM/dd/yyyy h:mm:ss tt", CultureInfo.InvariantCulture);
            ...
            entity.IsNotication = false;

            var Result = await PluginAnnouncementDomain.InsertAnnouncement(entity);
