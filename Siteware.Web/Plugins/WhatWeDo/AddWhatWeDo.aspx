<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AddWhatWeDo.aspx.cs" Inherits="Siteware.Web.Plugins.What_We_Do.AddWhatWeDo" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        <ul class="breadcrumbs">
            ...
            <li>Add What We Do Item</li>
        </ul>

        <div class="pageheader">
            <asp:Button ID="btnAdd2" runat="server" Text="Save" class="btn btn-primary" ValidationGroup="w1" OnClick="btnAdd2_Click"
                ...
                <div class="row">
                    <div class="col-lg-8" style="width: 100%;">
                                ...
                                <div id="a-1" style="min-height: 283px;">
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" InitialValue="0" ErrorMessage="Please Select Language" ID="validLang"
                                            ControlToValidate="ddLanguages" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="w1" EnableClientScript="True" />
                                    </div>
                                    <div class="form-group" style="height: 42px">
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ErrorMessage="Required Field" ID="RequiredFieldValidator1"
                                            ControlToValidate="txtFacilityOrder" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="w1" EnableClientScript="True" />
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" Style="left: 3%; position: relative; color: red;" ValidationGroup="w1"
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ValidationGroup="w1"
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ErrorMessage="Please Fill Date" ID="RequiredFieldValidator4"
                                            ControlToValidate="txtPublishDate" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="w1" EnableClientScript="True" />
                                    </div>
                                    <div class="form-group" style="height: 42px">
                        ...
                        <p style="text-align: right;">
                            <asp:Button ID="BtnAdd" runat="server" Text="Save" class="btn btn-primary" ValidationGroup="w1" OnClick="btnAdd2_Click" />
                        </p>
                    </div>
                </div>
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">What We Do Information Add Sucessfully</div>
            <div id="popup_panel">
