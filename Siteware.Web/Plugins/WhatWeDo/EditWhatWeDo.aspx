<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditWhatWeDo.aspx.cs" Inherits="Siteware.Web.Plugins.What_We_Do.EditWhatWeDo" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        <ul class="breadcrumbs">
            ...
            <li>Edit
                <asp:Label ID="lblFacilityName1" runat="server"></asp:Label>
                Item</li>
        </ul>
        ...
        <div class="pageheader">
            ...
            <div class="pagetitle">
                ...
                <h1>Edit
                    <asp:Label ID="lblFacilityName2" runat="server"></asp:Label>
                    Item</h1>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-8" style="width: 100%;">
                        <div class="widgetbox personal-information">
                            ...
                            <div class="tabbedwidget tab-primary" style="min-height: 330px;">
                                ...
                                <div id="a-1" style="min-height: 283px;">
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" InitialValue="0" ErrorMessage="Please Select Language" ID="validLang"
                                            ControlToValidate="ddLanguages" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="w2" EnableClientScript="True" />
                                    </div>
                                    <div class="form-group" style="height: 42px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 11%; padding-left: 1.2%;"> Name:</label>
                                        <div class="col-md-10" style="width: 22.9%;">
                                            <asp:TextBox ID="txtFacilityName" runat="server" PlaceHolder="Name" class="form-control"></asp:TextBox>
                                        </div>
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <div class="col-md-10" style="width: 9%;">
                                            <asp:TextBox ID="txtFacilityOrder" runat="server" PlaceHolder="Order" class="form-control"></asp:TextBox>
                                        </div>
                                        <asp:RequiredFieldValidator runat="server" ErrorMessage="Required Field" ID="RequiredFieldValidator1"
                                            ControlToValidate="txtFacilityOrder" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="w2" EnableClientScript="True" />
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" Style="left: 3%; position: relative; color: red;" ValidationGroup="w2"
                                            ControlToValidate="txtFacilityOrder" runat="server" ErrorMessage="Only Numbers allowed" ValidationExpression="\d+">
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ValidationGroup="w2"
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ErrorMessage="Please Fill Date" ID="RequiredFieldValidator4"
                                            ControlToValidate="txtPublishDate" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="w2" EnableClientScript="True" />
                                    </div>
                                ...
                                <div id="a-3" style="min-height: 283px;">
                                    <div class="form-group">
                                        <CKEditor:CKEditorControl ID="txtFacilitySummary" runat="server"></CKEditor:CKEditorControl>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <p style="text-align: right;">
                            <asp:Button ID="BtnAdd" runat="server" Text="Save" class="btn btn-primary" ValidationGroup="w2" OnClick="btnAdd2_Click" />
                        </p>
                    </div>
                </div>
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">What We Do Information Update Sucessfully</div>
            <div id="popup_panel">
