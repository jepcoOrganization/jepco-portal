...
{
    public partial class EditSubWhatWeDo : System.Web.UI.Page
    {
        ...
        protected async void btnAdd2_Click(object sender, EventArgs e)
        {
            try
            {
                if (Session["SubFacilityIDSession"] != null)
                {
                    ...
                    entity.ID = Convert.ToInt64(Session["SubFacilityIDSession"].ToString());
                    ...
                    var Result = await Plugin_Facility_Domain.UpdateFacility(entity);
        ...
        protected void FillDetails()
        {
            try
            {
                if (Session["SubFacilityIDSession"] != null)
                {
                    long ID = Convert.ToInt64(Session["SubFacilityIDSession"].ToString());
