<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditMenuFooter.aspx.cs" Inherits="Siteware.Web.Plugins.MenuFooter.EditMenuFooter" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <ul class="breadcrumbs">
            ...
            <li><a href="../MenuFooter/ManageMenuFooter.aspx">Menu Footer List</a> <span class="separator"></span></li>
            <li>Edit <asp:Label ID="lblMenuFootername1" runat="server"></asp:Label> List</li>           
        </ul>

        <div class="pageheader">
            <asp:Button ID="btnAdd2" runat="server" Text="Save" class="btn btn-primary" ValidationGroup="m12" OnClick="btnAdd2_Click"
                ...
                <div class="row">
                    <div class="col-lg-8" style="width: 100%;">
                            ...
                            <h4 class="widgettitle">Menu Footer Information</h4>
                                    <div class="widgetcontent form-horizontal">
                                        <div class="form-group">
                                            ...
                                            ControlToValidate="txtTitle" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="m12" EnableClientScript="True" />
                                        </div>
                                        <div class="form-group">
                                            ...
                                            ControlToValidate="txtURL" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="m12" EnableClientScript="True" />
                                        </div>
                                        <div class="form-group">
                                            ...
                                            ControlToValidate="ddlTargetID" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="m12" EnableClientScript="True" />
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ErrorMessage="Please Fill Date" ID="RequiredFieldValidator4"
                                            ControlToValidate="txtPublishDate" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="m12" EnableClientScript="True" />
                                        </div>
                                        <div class="form-group">
                        ...
                        <p style="text-align: right;">
                            <asp:Button ID="BtnAdd" runat="server" Text="Save" class="btn btn-primary" ValidationGroup="m12" OnClick="btnAdd2_Click"/>
                        </p>
                    </div>
                </div>
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">Menu Footer Updated Sucessfully</div>
            <div id="popup_panel">
