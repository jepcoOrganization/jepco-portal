<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditFocusEntities.aspx.cs" Inherits="Siteware.Web.Plugins.FocusEntity.EditFocusEntities" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        <ul class="breadcrumbs">
            ...
            <li><a href="ManageFocusEntities.aspx">Entity List</a> <span class="separator"></span></li>
            <li>Edit
                        ...
                        <div class="widgetbox personal-information">
                            <div class="tabbedwidget tab-primary" style="min-height: 330px;">
                                <ul>
                                    ...
                                    <li><a href="#a-3" style="font-size: 14px;">Image</a></li>
                                    <li><a href="#a-4" style="font-size: 14px;">Map Entity</a></li>
                                </ul>
                                <div id="a-1" style="min-height: 283px;">
                                    <asp:HiddenField runat="server" ID="hdnFocusEntityId" />
                                    <asp:HiddenField runat="server" ID="lblLanguageID" />
                                    <asp:HiddenField runat="server" ID="lblFocusID" />
                                    <asp:HiddenField runat="server" ID="lblMapID" />
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 11%; padding-left: 1.2%;">Select Focus:</label>
                                        <div class="col-md-10" style="width: 22.9%;">
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 11%; padding-left: 1.2%;">Title1:</label>
                                        <div class="col-md-10" style="width: 23.9%;">
                                            <asp:TextBox ID="txtTitle1" runat="server" PlaceHolder="Title" class="form-control"></asp:TextBox>
                                        </div>
                                    ...
                                    <div class="form-group" style="height: 61px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 11%; padding-left: 1.2%;">Address:</label>
                                        <div class="col-md-10" style="width: 50%;">
                                            <asp:TextBox ID="txtAddress" runat="server" Style="height: 54px;" PlaceHolder="Address" class="form-control" TextMode="MultiLine"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group" style="height: 42px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 11%; padding-left: 1.2%;">Telephone:</label>
                                        <div class="col-md-10" style="width: 23.9%;">
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 11%; padding-left: 1.2%;">Fax:</label>
                                        <div class="col-md-10" style="width: 23.9%;">
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 15%; padding-left: 1.2%;">Show on Page:</label>
                                        <div class="col-md-10" style="width: 22%;">
                                            <asp:CheckBox ID="CBIsShowPage" runat="server" Style="position: relative; top: 4px;" />
                                        </div>
                                    </div>
                                    <div class="form-group" style="height: 42px">
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">Focus Entity Information Update Sucessfully</div>
            <div id="popup_panel">
