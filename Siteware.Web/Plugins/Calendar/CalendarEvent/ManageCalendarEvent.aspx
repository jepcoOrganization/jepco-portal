<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageCalendarEvent.aspx.cs" Inherits="Siteware.Web.Plugins.Calendar.CalendarEvent.ManageCalendarEvent" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        <ul class="breadcrumbs">
            ...
            <li><a href="../ManageCalendar.aspx">Calander List</a> <span class="separator"></span></li>
            <li>Event List</li>           
        </ul>
        ...
        <div class="pageheader">
            <div>                              
                <asp:LinkButton ID="BtnDelete2" runat="server" class="btn btn-primary" Text="Delete Page" OnClick="BtnDelete2_Click"
                    ...
                    <span class="glyphicon glyphicon-remove" style="color:white;padding-right: 4%;"></span> Delete Event Item
                </asp:LinkButton>          
        <%--        <asp:LinkButton ID="BtnPDF2" runat="server" class="btn btn-danger" Text="Export to PDF"
                ...
                <asp:LinkButton ID="btnAdd2" runat="server" class="btn btn-primary" Text="Add Pages" OnClick="btnAdd2_Click"
                                style="position: relative; float: right; top: 31px;right: 1.5%;color:white">
                    <span class="glyphicon glyphicon-plus" style="color:white;padding-right: 4%;"></span> Add Event Item
                </asp:LinkButton>
            </div>
                                        ...
                                        <table id="" class="table table-striped table-bordered table-hover dataTables-example">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="head1">Event Title</th>
                                                    <th class="head0">Entity Name</th>
                                                    <%--<th class="head1">Open In</th>--%>
                                                    <th class="head0">Event Date</th>
                                            ...
                                            <tbody>
                                                <asp:ListView ID="lstEvent" runat="server" OnItemDataBound="lstEvent_ItemDataBound" OnItemCommand="lstEvent_ItemCommand">
                                                    <ItemTemplate>
                                                        <tr class="gradeX">
                                                            ...
                                                            <td>
                                                                <asp:Label ID="lblCalendarID" runat="server" Text='<%# Bind("ID") %>'></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lblEventTitle" runat="server" Text='<%# Bind("EventTitle") %>'></asp:Label>
                                                            </td>
                                                            <td class="center">
                                                                <asp:Label ID="lblEventURL" runat="server" Text='<%# Bind("EntityName") %>'></asp:Label>
                                                            </td>
                                                            <%--<td class="center">
                                                                <asp:Label ID="lblTargetID" runat="server" Text='<%# Bind("TargetID") %>'></asp:Label>
                                                            </td>--%>
                                                            <td class="center">
                                                                <asp:Label ID="lblEventTime" runat="server" Text='<%# Bind("EventTime") %>'></asp:Label>
                                                            </td>
                                                            <td class="center">
                                                            ...
                                                            <td class="center">&nbsp;
                                    <asp:LinkButton ID="lnkEdit" runat="server" CommandName="ViewEdit" CommandArgument='<%# Eval("ID") %>' ToolTip="Edit Event">
                                        <span class="glyphicon iconsweets-create"></span>
                                    </asp:LinkButton>
                                                                &nbsp;
                                    <asp:LinkButton ID="lnkDelete" runat="server" CommandName="DeleteItem" CommandArgument='<%# Eval("ID") %>' ToolTip="Delete Event">
        ...
        $(document).ready(function () {
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    //{ extend: 'copy' },
                    //{ extend: 'csv' },
                    { extend: 'excel', title: 'Calendar Event', text: '<span class="glyphicon glyphicon-file" style="color:white;padding-right: 4%;"></span> Export to Excel', className: 'btn btn-success btn-Excel', titleAttr: 'Excel' },
                    { extend: 'pdf', title: 'Calendar Event', text: '<span class="glyphicon glyphicon-file" style="color:white;padding-right: 4%;"></span> Export to PDF', className: 'btn btn-success btn-PDF', titleAttr: 'PDF' },
                     {
                         extend: 'print', title: 'Calendar Event', text: '<span class="glyphicon glyphicon-file" style="color:white;padding-right: 4%;"></span> Print', className: 'btn btn-success btn-Print', titleAttr: 'Print',
