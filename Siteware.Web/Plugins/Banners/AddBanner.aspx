<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AddBanner.aspx.cs" Inherits="Siteware.Web.Pages.AddBanner" Async="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            $("#<%=ddlBannerCtg.ClientID%>").change(function () {
                debugger;
                var a = $("#<%=ddlBannerCtg.ClientID%>").val();
                if (a == "1") {
                    $("#liSummary").css("display", "none");
                    $("a2").css("display", "");
                    $("#formTitle2").css("display", "none");
                    $("#liImage").css("display", "");
                    $("a3").css("display", "");
                }
                else if (a == "5")
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        <ul class="breadcrumbs">
            ...
            <li><a href="../Banners/ManageBanner.aspx">Banners List</a> <span class="separator"></span></li>
            <li>Add Banner</li>
        </ul>
                ...
                <div class="row">
                    <div class="col-lg-8" style="width: 100%;">
                        <div class="widgetbox personal-information">
                            <div class="tabbedwidget tab-primary" style="min-height: 425px;">
                                <ul>
                                    <li><a href="#a1" style="font-size: 14px;">Banner Information</a></li>
                                    <li><a href="#a4" style="font-size: 14px;">Banner Title</a></li>
                                    <li id="liSummary" style="display:none;"><a href="#a2" style="font-size: 14px;">Sammery</a></li>
                                    <%--   runat="server" id="Summerytxt" visible="false"--%>
                                    <li id="liImage" style="display:none;"><a href="#a3" style="font-size: 14px;">Banner Image </a></li>
                                    <%--  runat="server" id="BannesImage" visible="false"--%>
                                </ul>
                                <br />
                                <div id="a1" style="min-height: 283px;">
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <div class="col-md-10" style="width: 22%;">
                                            <asp:DropDownList ID="ddlBannerCtg" runat="server" class="chzn-select" Style="width: 273px;" TabIndex="2" Width="100%">
                                            </asp:DropDownList>
                                        </div>
                                         <asp:RequiredFieldValidator runat="server" InitialValue="0" Style="margin: 70px;" ErrorMessage="Please Select Category" ID="RequiredFieldValidator3"
                                            ControlToValidate="ddlBannerCtg" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="1" EnableClientScript="True" />
                                    </div>
                                    <%-- <div class="form-group" style="height: 42px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 15%; padding-left: 1.2%;">Title:</label>
                                        <div class="col-md-10" style="width: 22.9%;">
                                            <asp:TextBox ID="TextBox1" runat="server" PlaceHolder="Title" Style="width: 273px;" class="form-control"></asp:TextBox>
                                        </div>

                                    </div>--%>
                                    <div class="form-group" style="height: 42px;display:none;" id="formTitle2" >
                                        <label class="col-md-2 control-label" style="text-align: left; width: 15%; padding-left: 1.2%;">Title 2:</label>
                                        <div class="col-md-10" style="width: 22.9%;">
                                            <asp:TextBox ID="txtTitle2" runat="server" PlaceHolder="Title2" Style="width: 273px;" class="form-control"></asp:TextBox>
                                        </div>
                                    ...
                                    <div class="form-group" style="height: 42px; display: none;">
                                        ...
                                        <div class="col-md-10" style="width: 22.9%;">
                                            <asp:TextBox ID="txtSammery" runat="server" PlaceHolder="Title" Style="width: 273px;" class="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group" style="height: 42px; display: none;">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 15%; padding-left: 1.2%;">LinkName:</label>
                                        <div class="col-md-10" style="width: 22.9%;">
                                            <asp:TextBox ID="txtlinkName" runat="server" PlaceHolder="LinkName" Style="width: 273px;" class="form-control"></asp:TextBox>
                                        </div>
                                ...
                                <div id="a4" style="min-height: 283px;">
                                    <CKEditor:CKEditorControl ID="txtTitle1" runat="server"></CKEditor:CKEditorControl>
                                </div>

                                <div id="a2" style="min-height: 283px;display:none;">
                                    <CKEditor:CKEditorControl ID="txtDescription" runat="server"></CKEditor:CKEditorControl>
                                </div>

                                <div id="a3" style="min-height: 283px;" visible="false">
                                    ...
                                    <%--<div class="form-group" style="display: none;">
                                        <div class="widgetbox profile-photo" style="width: 39.5%; padding-left: 15px;">
                                            <div class="profilethumb" id="logotransitions2" style="min-height: 150px;">
                                                <asp:Image ID="imgSchoolIcon" runat="server" alt="" class="img-polaroid" Style="max-height: 109px; min-height: 109px; padding-top: 5px;" />
                                        ...
                                        <div class="form-group">
                                            <a class="btn btn-primary btn-lg" style="color: white" href="#FileBrowserModal2" data-toggle="modal">Choose a SchoolIcon</a>
                                        </div>
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">Banner Information Add Sucessfully</div>
            <div id="popup_panel">
