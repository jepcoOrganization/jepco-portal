<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageMenuFooter.aspx.cs" Inherits="Siteware.Web.FooterNavigation.ManageMenuFooter" Async="true" %>
                                ...
                                <div class="ibox-content">
                                    ...
                                    <asp:LinkButton ID="lnkDelete" runat="server" CommandName="DeleteItem" CommandArgument='<%# Eval("ID") %>' ToolTip="Delete Menu Footer">
                                        <span class="glyphicon glyphicon-remove ColorDelete" style="position: relative;top: 3px;"></span>
                                                                 ...
                                                                 &nbsp;
                                    <asp:LinkButton ID="lnkSubMenu" runat="server" CommandName="SubMenuItem" CommandArgument='<%# Eval("ID")+","+Eval("LanguageID") %>' ToolTip="Sub Menu">
