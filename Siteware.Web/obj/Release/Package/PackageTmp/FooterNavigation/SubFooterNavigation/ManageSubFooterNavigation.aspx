<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageSubFooterNavigation.aspx.cs" Inherits="Siteware.Web.FooterNavigation.SubFooterNavigation.ManageSubFooterNavigation" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        <ul class="breadcrumbs">
            ...
            <li><a href="../ManageMenuFooter.aspx">Menu Footer List</a> <span class="separator"></span></li>
            <li>SubMenu Footer List</li>
        </ul>
        ...
        <div class="pageheader">
            <div>
                <asp:LinkButton ID="BtnDelete2" runat="server" class="btn btn-primary" Text="Delete Page" OnClick="BtnDelete2_Click"
                    ...
                    <span class="glyphicon glyphicon-remove" style="color:white;padding-right: 4%;"></span> Delete SubMenu Footer
                </asp:LinkButton>
                <asp:LinkButton ID="btnAdd2" runat="server" class="btn btn-primary" Text="Add Pages" OnClick="btnAdd2_Click"
                    ...
                    <span class="glyphicon glyphicon-plus" style="color:white;padding-right: 4%;"></span> Add SubMenu Footer
                </asp:LinkButton>
            </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            //    url: "ManageMenuFooter.aspx/BindDatatoDropdown",
            //    data: "{}",
            //    dataType: "json",
            //    async: true,
