<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AddMenuFooter.aspx.cs" Inherits="Siteware.Web.FooterNavigation.AddMenuFooter" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
                                    ...
                                    <div class="widgetcontent form-horizontal">
                                        <div class="form-group" style="height: 42px">
                                            ...
                                            <asp:RequiredFieldValidator runat="server" InitialValue="0" ErrorMessage="Please Select Language" ID="validLang"
                                                ControlToValidate="ddlLanguages" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="m1" EnableClientScript="True" />
                                        </div>
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">Menu Footer Information Add Sucessfully</div>
            <div id="popup_panel">
