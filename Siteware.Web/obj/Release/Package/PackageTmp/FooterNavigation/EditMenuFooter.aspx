<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditMenuFooter.aspx.cs" Inherits="Siteware.Web.FooterNavigation.EditMenuFooter" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <ul class="breadcrumbs">
            ...
            <li><a href="../FooterNavigation/ManageMenuFooter.aspx">Menu Footer List</a> <span class="separator"></span></li>
            <li>Edit <asp:Label ID="lblMenuFootername1" runat="server"></asp:Label> List</li>           
        </ul>

        <div class="pageheader">
            <asp:Button ID="btnAdd2" runat="server" Text="Save" class="btn btn-primary" ValidationGroup="m2" OnClick="btnAdd2_Click"
            ...
            <div class="pagetitle">
                ...
                <h1>Edit <asp:Label ID="lblMenuFootername2" runat="server"></asp:Label> List</h1>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-8" style="width: 100%;">
                        <div class="widgetbox personal-information">
                            <h4 class="widgettitle">Menu Footer Information</h4>
                                    <div class="widgetcontent form-horizontal">
                                        <div class="form-group" style="height: 42px">
                                            ...
                                            <asp:RequiredFieldValidator runat="server" InitialValue="0" ErrorMessage="Please Select Language" ID="validLang"
                                                ControlToValidate="ddlLanguages" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="m2" EnableClientScript="True" />
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <asp:RequiredFieldValidator runat="server"  ErrorMessage="Required Field" ID="RequiredFieldValidator1"
                                                ControlToValidate="txtTitle" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="m2" EnableClientScript="True" />
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <asp:RequiredFieldValidator runat="server"  ErrorMessage="Required Field" ID="RequiredFieldValidator3"
                                                ControlToValidate="txtURL" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="m2" EnableClientScript="True" />
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <asp:RequiredFieldValidator runat="server"  ErrorMessage="Required Field" ID="RequiredFieldValidator2"
                                                ControlToValidate="txtMenuOrder" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="m2" EnableClientScript="True" />
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10" style="width: 22.9%;">
                                                <input id="txtPublishDate" runat="server" type="text" placeholder="mm/dd/yyyy" name="date" class="Dateeee form-control" />
                                                   ...
                                                   <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ValidationGroup="m2"
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ErrorMessage="Please Fill Date" ID="RequiredFieldValidator4"
                                            ControlToValidate="txtPublishDate" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="m2" EnableClientScript="True" />
                                        </div>
                                        <div class="form-group">
                        ...
                        <p style="text-align: right;">
                            <asp:Button ID="BtnAdd" runat="server" Text="Save" class="btn btn-primary" ValidationGroup="m2" OnClick="btnAdd2_Click"/>
                        </p>
                    </div>
                </div>
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">Menu Footer Information Update Sucessfully</div>
            <div id="popup_panel">
