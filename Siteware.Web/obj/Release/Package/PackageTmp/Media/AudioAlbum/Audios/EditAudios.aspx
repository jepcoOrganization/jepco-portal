<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditAudios.aspx.cs" Inherits="Siteware.Web.Pages.EditAudios" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        <ul class="breadcrumbs">
            ...
            <li><a href="../Media/ManageBanner.aspx">Audio List</a> <span class="separator"></span></li>
            <li>Edit Audio
                    ...
                    <div class="col-lg-8" style="width: 100%;">
                        <div class="widgetbox personal-information">
                            <div class="tabbedwidget tab-primary" style="min-height: 385px;">
                                 <ul>
                                    <li><a href="#a-1" style="font-size: 14px;">Audio Information</a></li>
                                    <li><a href="#a-2" style="font-size: 14px;">Audio Link</a></li>
                                    <li><a href="#a-3" style="font-size: 14px;">Cover Audio</a></li>
                                </ul>
                                <br />
                                ...
                                <div id="a-2" style="min-height: 283px;">
                                         ...
                                         <script>
                                             $(document).ready(function () {
                                                 $('#sur1').attr('src', $('#<%= newWinField2.ClientID %>').val()).appendTo($('#AudioID'));
                                                 $('#sur2').attr('src', $('#<%= newWinField2.ClientID %>').val()).appendTo($('#AudioID'));
                                             });
                                             function fileBrowserCallBack2(fileurl) {
                                                 // $('<source />').attr('src', path).appendTo('#AudioIDCont');
                                                 //$('#AudioIDCont').attr('src', src);
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">Audio Information Update Sucessfully</div>
            <div id="popup_panel">
