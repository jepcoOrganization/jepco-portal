<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageSecondNavigation.aspx.cs" Inherits="Siteware.Web.SecondNavigation.ManageSecondNavigation" Async="true" %>
                            ...
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                        ...
                                        <table id="mytbl" class="table table-striped table-bordered table-hover dataTables-example">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="head3">URL</th>
                                                    <th class="head4">Open In</th>
                                                     <th class="head9">Menu Type</th>
                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="gradeX">
                                                            ...
                                                            <td class="center">
                                                             ...
                                                             <td class="center">
                                                                <asp:Label ID="lblMenutype" runat="server" Text='<%# Bind("MenuType") %>'></asp:Label>
                                                            </td>
                                    ...
                                    <asp:LinkButton ID="lnkDelete" runat="server" CommandName="DeleteItem" CommandArgument='<%# Eval("ID") %>' ToolTip="Delete Menu">
                                      ...
                                      <%--                          &nbsp;
                                    <asp:LinkButton ID="lnkSubMenu" runat="server" CommandName="SubMenuItem" CommandArgument='<%# Eval("ID") %>' ToolTip="Sub Menu">
        ...
        $(document).ready(function () {
            var table = $('.dataTables-example').DataTable({
                ...
                buttons: [
                    //{ extend: 'copy' },
                    //{ extend: 'csv' },
                    { extend: 'excel', title: 'Second Navigation', text: '<span class="glyphicon glyphicon-file" style="color:white;padding-right: 4%;"></span> Export to Excel', className: 'btn btn-success btn-Excel', titleAttr: 'Excel' },
                    { extend: 'pdf', title: 'Second Navigation', text: '<span class="glyphicon glyphicon-file" style="color:white;padding-right: 4%;"></span> Export to PDF', className: 'btn btn-success btn-PDF', titleAttr: 'PDF' },
                     {
                         extend: 'print', title: 'Second Navigation', text: '<span class="glyphicon glyphicon-file" style="color:white;padding-right: 4%;"></span> Print', className: 'btn btn-success btn-Print', titleAttr: 'Print',
            ...
            $.ajax({
                ...
                url: "ManageSecondNavigation.aspx/BindDatatoDropdown",
                data: "{}",
                dataType: "json",
                async: true,
