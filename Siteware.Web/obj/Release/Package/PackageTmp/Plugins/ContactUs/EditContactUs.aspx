<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditContactUs.aspx.cs" Inherits="Siteware.Web.Pages.EditContactUs" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        <ul class="breadcrumbs">
            ...
            <li><a href="../ContactUs/ManageContactUs.aspx">Contact Us List</a> <span class="separator"></span></li>
            <li>Edit Contact Us
                <asp:Label ID="lblPagename1" runat="server"></asp:Label></li>
        </ul>

        <div class="pageheader">
            <asp:Button ID="btnUpdate2" runat="server" Text="Save" class="btn btn-primary" ValidationGroup="c2" OnClick="btnUpdate_Click"
                    ...
                    <div class="col-lg-8" style="width: 100%;">
                        <div class="widgetbox personal-information">
                            <div class="tabbedwidget tab-primary" style="min-height: 330px;">
                                <ul>
                                    <li><a href="#a-1" style="font-size: 14px;">Contact Us Information</a></li>
                              <%--      <li><a href="#a-2" style="font-size: 14px;">SEO Attributes</a></li>--%>
                                    <li><a href="#a-3" style="font-size: 14px;">Image Banner</a></li>
                                </ul>
                                <br />
                                <div id="a-1" style="min-height: 283px;">
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" InitialValue="0" ErrorMessage="Please Select Language" ID="validLang1"
                                            ControlToValidate="ddlLanguages" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="c2" EnableClientScript="True" />
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <div class="col-md-10" style="width: 22.9%;">
                                            <asp:TextBox ID="txtTitles" runat="server" PlaceHolder="Title" Style="width: 207px;" class="form-control"></asp:TextBox>
                                        </div>
                                        <asp:RequiredFieldValidator runat="server"  ErrorMessage="Required" ID="RequiredFieldValidator4"
                                            ControlToValidate="txtTitles" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="c2" EnableClientScript="True" />
                                    </div>


                                    <div class="form-group" style="height: 42px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 15%; padding-left: 1.2%;">Title Number:</label>
                                        <div class="col-md-10" style="width: 22.9%;">
                                            <asp:TextBox ID="txtPageName" runat="server" PlaceHolder="Title Number" Style="width: 207px;" class="form-control"></asp:TextBox>
                                        </div>
                                        <asp:RequiredFieldValidator runat="server"  ErrorMessage="Required" ID="RequiredFieldValidator1"
                                            ControlToValidate="txtPageName" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="c2" EnableClientScript="True" />
                                    </div>
                                    <div class="form-group" style="height: 42px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 15%; padding-left: 1.2%;">URL:</label>
                                        <div class="col-md-10" style="width: 22.9%;">
                                            <asp:TextBox ID="txtURL" runat="server" PlaceHolder="URL" class="form-control" Style="width: 207px;"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <div class="col-md-10" style="width: 22%;">
                                            <asp:DropDownList ID="ddlTarget" runat="server" class="chzn-select" Style="width: 207px;" TabIndex="2" Width="100%">
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <div class="col-md-10" style="width: 22%;">
                                            <asp:TextBox ID="txtLatitude" runat="server" PlaceHolder="Latitude" class="form-control" Style="width: 207px;"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group" style="height: 42px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 15%; padding-left: 1.2%;">Longitude:</label>
                                        <div class="col-md-10" style="width: 22%;">
                                            <asp:TextBox ID="txtLongitude" runat="server" PlaceHolder="Longitude" class="form-control" Style="width: 207px;"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group" style="height: 42px">
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ErrorMessage="Required Field" ID="RequiredFieldValidator3"
                                            ControlToValidate="txtorderr" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="c2" EnableClientScript="True" />
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" Style="left: 3%; position: relative; color: red;" ValidationGroup="c2"
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ValidationGroup="c2"
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ErrorMessage="Please Fill Date" ID="RequiredFieldValidator2"
                                            ControlToValidate="txtPublishDate" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="c2" EnableClientScript="True" />
                                    </div>
                                </div> 
                        ...
                        <p style="text-align: right;">
                            <asp:Button ID="btnUpdate" runat="server" Text="Save" class="btn btn-primary" ValidationGroup="c2" OnClick="btnUpdate_Click" />
                        </p>
                    </div>
                </div>
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">Conatct Us Information Update Sucessfully</div>
            <div id="popup_panel">
    ...
    <cc2:ModalPopupExtender ID="mpeSuccess" runat="server"
