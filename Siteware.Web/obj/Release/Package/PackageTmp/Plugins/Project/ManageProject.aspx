<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageProject.aspx.cs" Inherits="Siteware.Web.Plugins.Project.ManageProject" %>
        ...
        <div class="pageheader">
            <div>
                <asp:LinkButton ID="BtnDelete2" runat="server" class="btn btn-primary" Text="Delete Page" OnClick="BtnDelete2_Click"
                    ...
                    <span class="glyphicon glyphicon-remove" style="color:white;padding-right: 4%;"></span> Delete Project
                </asp:LinkButton>
                ...
                <asp:LinkButton ID="btnAdd2" runat="server" class="btn btn-primary" Text="Add Pages" OnClick="btnAdd2_Click"
                    Style="position: relative; float: right; top: 31px; right: 0.5%; color: white">
                    <span class="glyphicon glyphicon-plus" style="color:white;padding-right: 4%;"></span> Add Project
                </asp:LinkButton>
            </div>
                                ...
                                <div class="ibox-content">
                                    <div class="table-responsive">
                                        <table id="mytbl" class="table table-striped table-bordered table-hover dataTables-example">
                                            ...
                                            <tbody>
                                                <asp:ListView ID="lstProject" runat="server" OnItemDataBound="lstProject_ItemDataBound" OnItemCommand="lstProject_ItemCommand">
                                                    <ItemTemplate>
                                                        <tr class="gradeX">
                                                            ...
                                                            <td>
                                                                <asp:Label ID="lblFacilityID" runat="server" Text='<%# Bind("ID") %>'></asp:Label>
                                                            </td>
                                                            <td>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                url: "ManageProject.aspx/BindDatatoDropdown",
                data: "{}",
                dataType: "json",
                async: true,
