<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AddMenuFooter.aspx.cs" Inherits="Siteware.Web.Plugins.MenuFooter.AddMenuFooter" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        <ul class="breadcrumbs">
            ...
            <li>Add Menu Footer List</li>           
        </ul>

        <div class="pageheader">
            <asp:Button ID="btnAdd2" runat="server" Text="Save" class="btn btn-primary" ValidationGroup="m11" OnClick="btnAdd2_Click"
                ...
                <div class="row">
                    <div class="col-lg-8" style="width: 100%;">
                            ...
                            <h4 class="widgettitle">Menu Footer Information</h4>
                                    <div class="widgetcontent form-horizontal">
                                        <div class="form-group">
                                            ...
                                            ControlToValidate="txtTitle" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="m11" EnableClientScript="True" />
                                        </div>
                                        <div class="form-group">
                                            ...
                                            ControlToValidate="txtURL" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="m11" EnableClientScript="True" />
                                        </div>
                                        <div class="form-group">
                                            ...
                                            ControlToValidate="ddlTargetID" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="m11" EnableClientScript="True" />
                                        </div>
                                        <div class="form-group">
                                      ...
                                      <asp:RequiredFieldValidator runat="server" ErrorMessage="Please Fill Date" ID="RequiredFieldValidator4"
                                            ControlToValidate="txtPublishDate" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="m11" EnableClientScript="True" />
                                        </div>
                                        <div class="form-group">
                        ...
                        <p style="text-align: right;">
                            <asp:Button ID="BtnAdd" runat="server" Text="Save" class="btn btn-primary" ValidationGroup="m11" OnClick="btnAdd2_Click"/>
                        </p>
                    </div>
                </div>
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">Menu Footer Added Sucessfully</div>
            <div id="popup_panel">
