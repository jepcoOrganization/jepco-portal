<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AddStatisticNote.aspx.cs" Inherits="Siteware.Web.Plugins.WelcomeNote.AddWelcomeNote" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        <ul class="breadcrumbs">
            ...
            <li>Add Statistic Note List</li>
        </ul>

        <div class="pageheader">
            <asp:Button ID="btnAdd2" runat="server" Text="Save" class="btn btn-primary" ValidationGroup="s11" OnClick="btnAdd2_Click"
                ...
                <div class="row">
                    <div class="col-lg-8" style="width: 100%;">
                        <div class="widgetbox personal-information">
                            <%--<h4 class="widgettitle">Welcome Note Information</h4>--%>
                            ...
                            <div class="tabbedwidget tab-primary" style="min-height: 330px;">
                                <ul>
                                    ...
                                    <li id="HeadlineImage" runat="server"><a href="#a-2">Welcome Note Logo</a></li>
                                ...
                                <div id="a-1" style="min-height: 283px;">
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ErrorMessage="Please Fill Date" ID="RequiredFieldValidator10"
                                            ControlToValidate="txtTitle" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="s11" EnableClientScript="True" />
                                    </div>
                                    <div class="form-group" style="height: 42px; ">
                                    ...
                                    <div class="form-group" style="height: 42px;">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ErrorMessage="Please Fill Date" ID="RequiredFieldValidator2"
                                            ControlToValidate="ddlTargetID" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="s11" EnableClientScript="True" />
                                    </div>
                                    <%--<div class="form-group" style="height: 132px; ">
                                        ...
                                        <div class="col-md-10" style="width: 80%;">
                                            <asp:TextBox ID="txtSummary" runat="server" PlaceHolder="Summary" class="form-control" TextMode="MultiLine" Rows="6"></asp:TextBox>
                                        </div>
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ValidationGroup="s11"
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ErrorMessage="Please Fill Date" ID="RequiredFieldValidator4"
                                            ControlToValidate="txtPublishDate" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="s11" EnableClientScript="True" />
                                    </div>
                                    <div class="form-group" style="height: 42px">
                        ...
                        <p style="text-align: right;">
                            <asp:Button ID="BtnAdd" runat="server" Text="Save" class="btn btn-primary" ValidationGroup="s11" OnClick="btnAdd2_Click" />
                        </p>
                    </div>
                </div>
                <div class="footer">
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">Statistic Note Added Sucessfully</div>
            <div id="popup_panel">
