<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditStatisticNote.aspx.cs" Inherits="Siteware.Web.Plugins.WelcomeNote.EditWelcomeNote" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        <ul class="breadcrumbs">
            ...
            <li><a href="../StatisticNote/ManageStatisticNote.aspx">Statistic Note List</a> <span class="separator"></span></li>
            <li>Edit
                <asp:Label ID="lblWelcomeNoteName1" runat="server"></asp:Label>
                List</li>
        </ul>

        <div class="pageheader">
            <asp:Button ID="btnAdd2" runat="server" Text="Save" class="btn btn-primary" ValidationGroup="s12" OnClick="btnAdd2_Click"
            ...
            <div class="pagetitle">
                ...
                <h1>Edit
                    <asp:Label ID="lblWelcomeNoteName2" runat="server"></asp:Label>
                    List</h1>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-8" style="width: 100%;">
                        <div class="widgetbox personal-information">
                            <div class="tabbedwidget tab-primary" style="min-height: 300px;">
                                <ul>
                                    <li><a href="#a-1" style="font-size: 14px;">Welcome Note Information</a></li>
                                    <li id="HeadlineImage" runat="server"><a href="#a-2" style="font-size: 14px;">Welcome Note Logo</a></li>
                                    <li><a href="#a-3" style="font-size: 14px;">Description</a></li>
                                </ul>
                                <div id="a-1" style="min-height: 283px;">
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" InitialValue="0" ErrorMessage="Please Select Language" ID="validLang"
                                            ControlToValidate="ddlLanguages" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="s12" EnableClientScript="True" />
                                    </div>
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ErrorMessage="Please Fill Date" ID="RequiredFieldValidator1"
                                            ControlToValidate="txtTitle" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="s12"  EnableClientScript="True" />
                                    </div>
                                    <div class="form-group" style="height: 42px;">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 15%; padding-left: 1.2%;">Link:</label>
                                        <div class="col-md-10" style="width: 22.9%;">
                                            <asp:TextBox ID="txtLink" runat="server" PlaceHolder="Title" class="form-control"></asp:TextBox>
                                        </div>
                                        <asp:RequiredFieldValidator runat="server" ErrorMessage="Please Fill Date" ID="RequiredFieldValidator2"
                                            ControlToValidate="txtLink" Display="Dynamic" Text="Required Field" ForeColor="Red"  EnableClientScript="True" />
                                    </div>
                                    <div class="form-group" style="height: 42px;">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ErrorMessage="Please Fill Date" ID="RequiredFieldValidator3"
                                            ControlToValidate="ddlTargetID" Display="Dynamic" Text="Required Field" ForeColor="Red"  EnableClientScript="True" />
                                    </div>
                                   <%-- <div class="form-group" style="height: 150px;display:none;">
                                        ...
                                        <div class="col-md-10" style="width: 80%;">
                                            <asp:TextBox ID="txtSummary" runat="server" PlaceHolder="Summary" class="form-control" TextMode="MultiLine" Rows="7"></asp:TextBox>
                                        </div>
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ErrorMessage="Please Fill Date" ID="RequiredFieldValidator4"
                                            ControlToValidate="txtPublishDate" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="s12"  EnableClientScript="True" />
                                    </div>
                                    <div class="form-group" style="height: 42px">
                        ...
                        <p style="text-align: right;">
                            <asp:Button ID="BtnAdd" runat="server" Text="Save" class="btn btn-primary" ValidationGroup="s12" OnClick="btnAdd2_Click" />
                        </p>
                    </div>
                </div>
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">Statistic Note Updated Sucessfully</div>
            <div id="popup_panel">
