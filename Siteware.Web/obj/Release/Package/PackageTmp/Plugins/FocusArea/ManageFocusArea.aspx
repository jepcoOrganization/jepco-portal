<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageFocusArea.aspx.cs" Inherits="Siteware.Web.Plugins.FocusArea.ManageFocusArea" Async="true" %>
        ...
        <div class="pageheader">
            <div>
                <asp:LinkButton ID="BtnDelete2" runat="server" class="btn btn-primary" Text="Delete Page" OnClick="BtnDelete2_Click"
                    ...
                    <span class="glyphicon glyphicon-remove" style="color:white;padding-right: 4%;"></span> Delete Focus Area
                </asp:LinkButton>
                ...
                <asp:LinkButton ID="btnAdd2" runat="server" class="btn btn-primary" Text="Add Pages" OnClick="btnAdd2_Click"
                    Style="position: relative; float: right; top: 31px; right: 0.5%; color: white">
                    <span class="glyphicon glyphicon-plus" style="color:white;padding-right: 4%;"></span> Add Focus Area
                </asp:LinkButton>
            </div>
                                        ...
                                        <table id="mytbl" class="table table-striped table-bordered table-hover dataTables-example">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="head1">Focus ID</th>
                                                    <th class="head2">Title</th>
                                                    <th class="head3">color</th>
                                            ...
                                            <tbody>
                                                <asp:ListView ID="lstFocusArea" runat="server" OnItemDataBound="lstFocusArea_ItemDataBound" OnItemCommand="lstFocusArea_ItemCommand">
                                                    <ItemTemplate>
                                                        <tr class="gradeX">
                                                            <td class="aligncenter">
                                                                <span class="center">
                                                                    <asp:CheckBox ID="CBID" runat="server" />
                                                                    <asp:Label ID="lblID" runat="server" Text='<%# Bind("FocusID") %>' Visible="false"></asp:Label>
                                                                </span>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lblFocusID" runat="server" Text='<%# Bind("FocusID") %>'></asp:Label>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div runat="server" id ="divColor" style="background-color:#fff;width:auto;height:20px;"></div>
                                                            </td>
                                                            <td class="center">
                                                            ...
                                                            <td class="center">
                                                                <asp:Label ID="lblOrder" runat="server" Text='<%# Bind("FocusOrder") %>'></asp:Label>
                                                            </td>
                                                            <td class="center">
                                                            ...
                                                            <td class="center">&nbsp;
                                    <asp:LinkButton ID="lnkEdit" runat="server" CommandName="ViewEdit" CommandArgument='<%# Eval("FocusID") %>' ToolTip="Edit Focus Area">
                                        <span class="glyphicon iconsweets-create"></span>
                                    </asp:LinkButton>
                                                                &nbsp;
                                    <asp:LinkButton ID="lnkDelete" runat="server" CommandName="DeleteItem" CommandArgument='<%# Eval("FocusID") %>' ToolTip="Delete Focus Area">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                url: "ManageFocusArea.aspx/BindDatatoDropdown",
                data: "{}",
                dataType: "json",
                async: true,
