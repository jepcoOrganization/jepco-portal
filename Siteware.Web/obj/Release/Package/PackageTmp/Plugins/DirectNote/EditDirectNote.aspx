<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditDirectNote.aspx.cs" Inherits="Siteware.Web.Plugins.DirectNote.EditDirectNote" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        <ul class="breadcrumbs">
            ...
            <li><a href="ManageDirectNote.aspx">Direct Note List</a> <span class="separator"></span></li>
            <li>Edit
                    ...
                    <div class="col-lg-8" style="width: 100%;">
                        <div class="widgetbox personal-information">
                            <div class="tabbedwidget tab-primary" style="min-height: 330px;">
                                <ul>
                                    <li><a href="#a-1" style="font-size: 14px;">Direct Note Information</a></li>
                                    <li id="HeadlineImage" runat="server"><a href="#a-2">Direct Note Logo</a></li>
