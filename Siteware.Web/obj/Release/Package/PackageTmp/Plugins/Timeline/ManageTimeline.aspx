<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageTimeline.aspx.cs" Inherits="Siteware.Web.Plugins.Timeline.ManageTimeline" Async="true" %>
        ...
        <div class="pageheader">
            <div>
                <asp:LinkButton ID="BtnDelete2" runat="server" class="btn btn-primary" Text="Delete Page" OnClick="BtnDelete2_Click"
                    ...
                    <span class="glyphicon glyphicon-remove" style="color:white;padding-right: 4%;"></span> Delete Timeline
                </asp:LinkButton>
                ...
                <asp:LinkButton ID="btnAdd2" runat="server" class="btn btn-primary" Text="Add Pages" OnClick="btnAdd2_Click"
                    ...
                    <span class="glyphicon glyphicon-plus" style="color:white;padding-right: 4%;"></span> Add Timeline
                </asp:LinkButton>
            </div>
                                ...
                                <div class="ibox-content">
                                    <div class="table-responsive">
                                        <table id="mytbl" class="table table-striped table-bordered table-hover dataTables-example">
                                            ...
                                            <tbody>
                                                <asp:ListView ID="lstTimelineEntity" runat="server" OnItemDataBound="lstTimelineEntity_ItemDataBound" OnItemCommand="lstTimelineEntity_ItemCommand">
                                                    <ItemTemplate>
                                                        <tr class="gradeX">
                                                            <td class="aligncenter">
                                                                <span class="center">
                                                                    <asp:CheckBox ID="CBID" runat="server" />
                                                                    <asp:Label ID="lblID" runat="server" Text='<%# Bind("TimelineID") %>' Visible="false"></asp:Label>
                                                                </span>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lblFocusEntityId" runat="server" Text='<%# Bind("TimelineID") %>'></asp:Label>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td class="center">&nbsp;
                                    <asp:LinkButton ID="lnkEdit" runat="server" CommandName="ViewEdit" CommandArgument='<%# Eval("TimelineID") %>' ToolTip="Edit Timeline">
                                        <span class="glyphicon iconsweets-create"></span>
                                    </asp:LinkButton>
                                                                &nbsp;
                                    <asp:LinkButton ID="lnkDelete" runat="server" CommandName="DeleteItem" CommandArgument='<%# Eval("TimelineID") %>' ToolTip="Delete Timeline">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                url: "ManageTimeline.aspx/BindDatatoDropdown",
                data: "{}",
                dataType: "json",
                async: true,
