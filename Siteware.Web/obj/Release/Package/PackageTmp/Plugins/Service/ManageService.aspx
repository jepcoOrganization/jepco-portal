<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageService.aspx.cs" Inherits="Siteware.Web.Plugins.Service.ManageService" Async="true"  %>
        ...
        <div class="pageheader">
            <div>
                <asp:LinkButton ID="BtnDelete2" runat="server" class="btn btn-primary" Text="Delete Page" OnClick="BtnDelete2_Click"
                    ...
                    <span class="glyphicon glyphicon-remove" style="color:white;padding-right: 4%;"></span> Delete Service
                </asp:LinkButton>
                ...
                <asp:LinkButton ID="btnAdd2" runat="server" class="btn btn-primary" Text="Add Pages" OnClick="btnAdd2_Click"
                    Style="position: relative; float: right; top: 31px; right: 0.5%; color: white">
                    <span class="glyphicon glyphicon-plus" style="color:white;padding-right: 4%;"></span> Add Service
                </asp:LinkButton>
            </div>
                                        ...
                                        <table id="mytbl" class="table table-striped table-bordered table-hover dataTables-example">
                                            ...
                                            <thead>
                                                <tr>
                                                   ...
                                                   <%-- <th class="head10">Service Name</th>--%>
                                                ...
                                                <asp:ListView ID="lstDataPoint" runat="server" OnItemDataBound="lstDataPoint_ItemDataBound" OnItemCommand="lstDataPoint_ItemCommand">
                                                    <ItemTemplate>
                                                        <tr class="gradeX">
                                                            ...
                                                            <td class="center">&nbsp;
                                    <asp:LinkButton ID="lnkEdit" runat="server" CommandName="ViewEdit" CommandArgument='<%# Eval("ID") %>' ToolTip="Edit Service">
                                        <span class="glyphicon iconsweets-create"></span>
                                    </asp:LinkButton>
                                                                &nbsp;
                                    <asp:LinkButton ID="lnkDelete" runat="server" CommandName="DeleteItem" CommandArgument='<%# Eval("ID") %>' ToolTip="Delete Service">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                url: "ManageService.aspx/BindDatatoDropdown",
                data: "{}",
                dataType: "json",
                async: true,
