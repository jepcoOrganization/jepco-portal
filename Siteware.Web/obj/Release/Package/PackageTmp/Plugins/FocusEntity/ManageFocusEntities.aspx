<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageFocusEntities.aspx.cs" Inherits="Siteware.Web.Plugins.FocusEntity.ManageFocusEntities" Async="true" %>
        ...
        <div class="pageheader">
            <div>
                <asp:LinkButton ID="BtnDelete2" runat="server" class="btn btn-primary" Text="Delete Page" OnClick="BtnDelete2_Click"
                    ...
                    <span class="glyphicon glyphicon-remove" style="color:white;padding-right: 4%;"></span> Delete Entity
                </asp:LinkButton>
                ...
                <asp:LinkButton ID="btnAdd2" runat="server" class="btn btn-primary" Text="Add Pages" OnClick="btnAdd2_Click"
                    ...
                    <span class="glyphicon glyphicon-plus" style="color:white;padding-right: 4%;"></span> Add Entity
                </asp:LinkButton>
            </div>
                                        ...
                                        <table id="mytbl" class="table table-striped table-bordered table-hover dataTables-example">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="head3">Focus Area Name</th>
                                                    <th class="head4">Language</th>
                                                    <th class="head5">Order</th>
                                                    <th class="head6">Link</th>
                                            ...
                                            <tbody>
                                                <asp:ListView ID="lstFocusEntity" runat="server" OnItemDataBound="lstFocusEntity_ItemDataBound" OnItemCommand="lstFocusEntity_ItemCommand">
                                                    <ItemTemplate>
                                                        <tr class="gradeX">
                                                            <td class="aligncenter">
                                                                <span class="center">
                                                                    <asp:CheckBox ID="CBID" runat="server" />
                                                                    <asp:Label ID="lblID" runat="server" Text='<%# Bind("FocusEntityId") %>' Visible="false"></asp:Label>
                                                                </span>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lblFocusEntityId" runat="server" Text='<%# Bind("FocusEntityId") %>'></asp:Label>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td class="center">
                                                                ...
                                                                <asp:Label ID="lblPluginAreaTitle" runat="server" Text='<%# Bind("PluginAreaTitle") %>'></asp:Label>
                                                            </td>

                                                            <td class="center">
                                                                <asp:HiddenField runat="server" ID="lblLangID" Value='<%#Bind("LanguageID") %>' />
                                                            ...
                                                            <td class="center">
                                                                <asp:HyperLink runat="server" ID="lnkEntityDetail" Target="_blank"></asp:HyperLink>
                                                            </td>
                                                            <td class="center">
                                                            ...
                                                            <td class="center">&nbsp;
                                    <asp:LinkButton ID="lnkEdit" runat="server" CommandName="ViewEdit" CommandArgument='<%# Eval("FocusEntityId") %>' ToolTip="Edit Focus Area">
                                        <span class="glyphicon iconsweets-create"></span>
                                    </asp:LinkButton>
                                                                &nbsp;
                                    <asp:LinkButton ID="lnkDelete" runat="server" CommandName="DeleteItem" CommandArgument='<%# Eval("FocusEntityId") %>' ToolTip="Delete Focus Area">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                url: "ManageFocusEntities.aspx/BindDatatoDropdown",
                data: "{}",
                dataType: "json",
                async: true,
