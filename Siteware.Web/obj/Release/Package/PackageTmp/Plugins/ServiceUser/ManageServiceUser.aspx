<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.Master" CodeBehind="ManageServiceUser.aspx.cs" Inherits="Siteware.Web.Plugins.ServiceUser.ManageServiceUser" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        ...
        <div class="pageheader">
            <div>
                <asp:LinkButton ID="BtnDelete2" runat="server" class="btn btn-primary" Text="Delete Service User" OnClick="Delete_Click"
                    Style="position: relative; float: right; top: 31px; color: white">
                    <span class="glyphicon glyphicon-remove" style="color:white;padding-right: 4%;"></span> Delete Service User
                </asp:LinkButton>
                ...
                <asp:LinkButton ID="btnAdd2" runat="server" class="btn btn-primary" Text="Add Service User" OnClick="btnAdd_Click"
                    Style="position: relative; float: right; top: 31px; right: 0.5%; color: white">
                    <span class="glyphicon glyphicon-plus" style="color:white;padding-right: 4%;"></span> Add Service User
                </asp:LinkButton>
            </div>
                                        ...
                                        <table id="mytbl" class="table table-striped table-bordered table-hover dataTables-example">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="head4">User Type</th>
                                                    <th class="head5">Action</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <asp:ListView ID="lstPages" runat="server" OnItemCommand="lstPages_ItemCommand">
                                                    <ItemTemplate>
                                                        <tr class="gradeX">
                                                            ...
                                                            <td class="center">
                                                                <asp:Label ID="lblPageName" runat="server" Text='<%# Bind("FirstName") %>'></asp:Label>
                                                            </td>
                                                            <td class="center">
                                                                <asp:Label ID="lblLang" runat="server" Text='<%# Bind("LanguageName") %>'></asp:Label>
                                                            </td>
                                                            <td class="center">
                                                                <asp:Label ID="lblTarget" runat="server" Text='<%# Bind("UserType") %>'></asp:Label>
                                                            </td>
                                                            <%--  <td class="center">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                url: "ManageServiceUser.aspx/BindDatatoDropdown",
                data: "{}",
                dataType: "json",
                async: true,
