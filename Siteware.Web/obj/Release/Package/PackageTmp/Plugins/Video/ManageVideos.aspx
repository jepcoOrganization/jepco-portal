<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.Master" CodeBehind="ManageVideos.aspx.cs" Inherits="Siteware.Web.Plugins.Video.ManageVideo" Async="true" %>
                            ...
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                        ...
                                        <table id="mytbl" class="table table-striped table-bordered table-hover dataTables-example">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="head2">Video Title</th>
                                                    <th class="head3">Language</th>
                                                    <th class="head4">Video Cover</th>
                                                    <th class="head5">Target</th>
                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="gradeX">
                                                            ...
                                                            <td class="center">
                                                             ...
                                                             <td>
                                                                <asp:Image ID="lblImgCover" Style="height: 50px;width: 80px;" runat="server" ImageUrl='<%# Bind("CoverImage") %>'></asp:Image>
                                                            </td>
                                                            <td class="center">
                                    ...
                                    <asp:Label ID="lblIsDeleted" runat="server" ></asp:Label>
                                                            ...
                                                            <td class="center">&nbsp;
                                    <asp:LinkButton ID="lnkEdit" runat="server" CommandName="ViewEdit" CommandArgument='<%# Eval("ID") %>' ToolTip="Edit Price">
                                        <span class="glyphicon iconsweets-create"></span>
                                    </asp:LinkButton>
                                                                &nbsp;
                                    <asp:LinkButton ID="lnkDelete" runat="server" CommandName="DeleteItem" CommandArgument='<%# Eval("ID") %>' ToolTip="Delete Price">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                url: "ManageVideos.aspx/BindDatatoDropdown",
                data: "{}",
                dataType: "json",
                async: true,
