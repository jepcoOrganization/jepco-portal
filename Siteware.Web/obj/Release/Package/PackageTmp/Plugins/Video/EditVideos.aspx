<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.Master" CodeBehind="EditVideos.aspx.cs" Inherits="Siteware.Web.Plugins.Video.EditVideos" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        <ul class="breadcrumbs">
            ...
            <li><a href="../Video/ManageVideos.aspx">Video List</a> <span class="separator"></span></li>
            <li>Edit Video
                        ...
                        <div class="widgetbox personal-information">
                            <div class="tabbedwidget tab-primary" style="min-height: 330px;">
                                <ul>
                                    ...
                                    <li><a href="#a-3" style="font-size: 14px;">Cover Image</a></li>
                                </ul>
                                <br />
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">Video Information Update Sucessfully</div>
            <div id="popup_panel">
