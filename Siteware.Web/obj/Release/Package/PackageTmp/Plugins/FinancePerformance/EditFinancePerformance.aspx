<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.Master" CodeBehind="EditFinancePerformance.aspx.cs" Inherits="Siteware.Web.Plugins.FinancePerformance.EditFinancePerformance" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        <ul class="breadcrumbs">
            ...
            <li><a href="../FinancePerformance/ManageFinancePerformance.aspx">Daily Advise List</a> <span class="separator"></span></li>
