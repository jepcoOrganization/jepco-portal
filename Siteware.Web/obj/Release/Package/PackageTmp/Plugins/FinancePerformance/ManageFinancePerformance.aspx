<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.Master" CodeBehind="ManageFinancePerformance.aspx.cs" Inherits="Siteware.Web.Plugins.FinancePerformance.ManageFinancePerformance" Async="true" %>
    ...
    <div class="rightpanel">
        ...
        <div class="pageheader">
            ...
            <div class="pagetitle">
                ...
                <h1>Finance Performance List</h1>
            </div>
        </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                url: "ManageFinancePerformance.aspx/BindDatatoDropdown",
                data: "{}",
                dataType: "json",
                async: true,
