<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/MasterPage.Master" CodeBehind="ManageSubFinancePerformance.aspx.cs" Inherits="Siteware.Web.Plugins.FinancePerformance.SubFinancePerformance.ManageSubFinancePerformance" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        <ul class="breadcrumbs">
            ...
            <li><a href="../ManageFinancePerformance.aspx">Finance Performance List</a> <span class="separator"></span></li>
            <li>Sub Finance Performance</li>
        </ul>

        <div class="pageheader">
            <div>
                <asp:LinkButton ID="BtnDelete2" runat="server" class="btn btn-primary" Text="Delete Finance Performance" OnClick="BtnDelete2_Click"
                    Style="position: relative; float: right; top: 31px; color: white">
                    <span class="glyphicon glyphicon-remove" style="color:white;padding-right: 4%;"></span> Delete Finance Performance
                </asp:LinkButton>
                ...
                <asp:LinkButton ID="btnAdd2" runat="server" class="btn btn-primary" Text="Add Finance Performance" OnClick="btnAdd2_Click"
                    Style="position: relative; float: right; top: 31px; right: 0.5%; color: white">
                    <span class="glyphicon glyphicon-plus" style="color:white;padding-right: 4%;"></span> Add Finance Performance
                </asp:LinkButton>
            </div>
            ...
            <div class="pagetitle">
                ...
                <h1>Sub Finance Performance List</h1>
            </div>
        </div>
                                    ...
                                    <div class="table-responsive">
                                       <table id="mytbl" class="table table-striped table-bordered table-hover dataTables-example">
                                            ...
                                            <thead>
                                             ...
                                             <tbody>
                                                <asp:ListView ID="lstFinance" runat="server" OnItemDataBound="lstFinance_ItemDataBound" OnItemCommand="lstFinance_ItemCommand">
                                                    <ItemTemplate>
                                                        <tr class="gradeX">
                                                            <td class="aligncenter">
                                                                <span class="center">
                                                                    <asp:CheckBox ID="CBID" runat="server" />
                                                                    <asp:Label ID="lblID" runat="server" Text='<%# Bind("FinanceID") %>' Visible="false"></asp:Label>
                                                                </span>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lblMenuID" runat="server" Text='<%# Bind("FinanceID") %>'></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lblMenuName" runat="server" Text='<%# Bind("Title") %>'></asp:Label>
                                                            </td>
                                                            <td class="center">
                                                            ...
                                                            <td class="center">&nbsp;
                                    <asp:LinkButton ID="lnkEdit" runat="server" CommandName="ViewEdit" CommandArgument='<%# Eval("FinanceID") %>' ToolTip="Edit Finance Performance">
                                        <span class="glyphicon iconsweets-create"></span>
                                    </asp:LinkButton>
                                                                &nbsp;
                                    <asp:LinkButton ID="lnkDelete" runat="server" CommandName="DeleteItem" CommandArgument='<%# Eval("FinanceID") %>' ToolTip="Delete Finance Performance">
                                        <span class="glyphicon glyphicon-remove  ColorDelete" style="position: relative;top: 3px;"></span>
                                    </asp:LinkButton>
<%--                                                                &nbsp;
                                    <asp:LinkButton ID="lnkSubMenu" runat="server" CommandName="SubMenuItem" CommandArgument='<%# Eval("FinanceID")+","+Eval("LanguageID") %>' ToolTip="Sub Menu">
    ...
    <script>
        $('#selectAll').click(function (e) {
         ...
         $(document).ready(function () {
            ...
            //    url: "ManageSubFinancePerformance.aspx/BindDatatoDropdown",
            //    data: "{}",
            //    dataType: "json",
            //    async: true,
