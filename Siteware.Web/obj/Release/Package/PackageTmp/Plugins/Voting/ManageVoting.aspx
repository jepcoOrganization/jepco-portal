<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.Master" CodeBehind="ManageVoting.aspx.cs" Inherits="Siteware.Web.Plugins.Voting.ManageVoting" Async="true" %>
                                        ...
                                        <table id="mytbl" class="table table-striped table-bordered table-hover dataTables-example">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="head1">Voting ID</th>
                                                    <th class="head2">Voting Result</th>
                                            ...
                                            <tbody>
                                                <asp:ListView ID="lstVoting" runat="server" OnItemDataBound="lstVoting_ItemDataBound" OnItemCommand="lstVoting_ItemCommand">
                                                    <ItemTemplate>
                                                        <tr class="gradeX">
                                                            
                                                            <td>
                                                                <asp:Label ID="lblNewsID" runat="server" Text='<%# Bind("VotingID") %>'></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lblHeadline" runat="server" Text='<%# Bind("VotingResult") %>'></asp:Label>
                                                            </td>
                                                            <td class="center">
                                                            ...
                                                            <td class="center">&nbsp;
                                    <asp:LinkButton ID="lnkEdit" runat="server" CommandName="ViewEdit" CommandArgument='<%# Eval("VotingID") %>' ToolTip="View Data">
    ...
    <script>
        ...
        $(document).ready(function () {
          ...
          $.ajax({
                ...
                url: "ManageVoting.aspx/BindDatatoDropdown",
                data: "{}",
                dataType: "json",
                async: true,
