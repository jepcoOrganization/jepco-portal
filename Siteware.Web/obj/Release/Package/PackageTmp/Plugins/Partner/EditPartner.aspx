<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditPartner.aspx.cs" Inherits="Siteware.Web.Plugins.Partner.EditPartner" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        <ul class="breadcrumbs">
            ...
            <li><a href="../Partner/ManagePartner.aspx">Partner List</a> <span class="separator"></span></li>
            <li>Edit Partner
                    ...
                    <div class="col-lg-8" style="width: 100%;">
                        <div class="widgetbox personal-information">
                            <div class="tabbedwidget tab-primary" style="min-height: 330px;">
                                <ul>
                                    <li><a href="#a-1" style="font-size: 14px;">Partner Information</a></li>
                                    <li><a href="#a-2" style="font-size: 14px;">Partner Image</a></li>
                                ...
                                <div id="a-1" style="min-height: 283px;">
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <div class="col-md-10" style="width: 22.9%;">
                                            <asp:TextBox ID="txtName" runat="server" PlaceHolder="Name" Style="width: 273px;" class="form-control"></asp:TextBox>
                                        </div>
                                    </div>
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">Certification Information Update Sucessfully</div>
            <div id="popup_panel">
