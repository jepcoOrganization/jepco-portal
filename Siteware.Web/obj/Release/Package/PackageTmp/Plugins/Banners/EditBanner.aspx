<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditBanner.aspx.cs" Inherits="Siteware.Web.Pages.EditBanner" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <div class="tabbedwidget tab-primary" style="min-height: 425px;">
                                ...
                                <div id="a1" style="min-height: 283px;">
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" InitialValue="0" style="margin: 70px;" ErrorMessage="Please Select Catogory" ID="RequiredFieldValidator3"
                                   ...
                                   <%-- <div class="form-group" style="height: 42px">
                                    ...
                                    <div class="form-group" style="height:42px;display:none;">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 15%; padding-left: 1.2%;">LinkTitle:</label>
                                        <div class="col-md-10" style="width: 22.9%;">
                                            <asp:TextBox ID="txtLinkName" runat="server" PlaceHolder="LinkTitle" style="width: 273px;"  class="form-control"></asp:TextBox>
                                        </div>
                                ...
                                <div id="a4" style="min-height: 283px;">
                                    <CKEditor:CKEditorControl ID="txtPageName" runat="server"></CKEditor:CKEditorControl>
                                </div>
                               ...
                               <div id="a2" style="min-height: 283px;display:none;">
                                ...
                                <div id="a3" style="min-height: 283px;display:none;" >
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">Banner Information Update Sucessfully</div>
            <div id="popup_panel">
