<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageSlider.aspx.cs" Inherits="Siteware.Web.Pages.ManageSlider" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        ...
        <div class="pageheader">
            <div> 
                <asp:LinkButton ID="BtnDelete2" runat="server" class="btn btn-primary" Text="Delete Slider" OnClick="Delete_Click"
                    Style="position: relative; float: right; top: 31px; color: white">
                    <span class="glyphicon glyphicon-remove" style="color:white;padding-right: 4%;"></span> Delete Slider
                </asp:LinkButton>
            <%--    <asp:LinkButton ID="BtnPDF2" runat="server" class="btn btn-danger" Text="Export to PDF"
                ...
                <button class="btn btn-success" aria-controls="dyntable" tabindex="0" id="exbotBut"
                ...
                <asp:LinkButton ID="btnAdd2" runat="server" class="btn btn-primary" Text="Add Slider" OnClick="btnAdd_Click"
                    Style="position: relative; float: right; top: 31px; right:0.5%; color: white">
                    <span class="glyphicon glyphicon-plus" style="color:white;padding-right: 4%;"></span> Add Slider
                </asp:LinkButton>
            </div>
                                ...
                                <div class="ibox-content">
                                    <div class="table-responsive">
                                        <table id="mytbl" class="table table-striped table-bordered table-hover dataTables-example">
                                            <colgroup>
                                                <col class="c" style="align: center; width: 4%" />
                                                <col class="con1" />
                                                <col class="con0" />
                                                <col class="con1" />
                                                <col class="con0" />
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="head1">Slider ID</th>
                                                    <th class="head2">Slider Title</th>
                                                    <th class="head3">Slider Sammary</th>
                                                    <th class="head4">Language</th>
                                                    <th class="head5">Order</th>
                                                    <th class="head6">Is Publish</th>
                                                    <th class="head7">Target</th>
                                                    <th class="head8">Action</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                    ...
                                    <asp:Label ID="lblIsDeleted" runat="server" ></asp:Label>
                                                             ...
                                                             <td>
                                                                <asp:Label ID="lblSummary" runat="server" Text='<%# Bind("Sammery") %>'></asp:Label>
                                                            </td>
                                                            <td class="center">
                                                            ...
                                                            <td>
                                                                <asp:Label ID="lblIsPublish" runat="server" Text='<%# Bind("IsPublish") %>'></asp:Label>
                                                            </td>                                                            
                                                            <td class="center">
                                                                <asp:Label ID="lblTaget" runat="server" Text='<%# Bind("Target") %>'></asp:Label>
                                                            </td>
                                                            <td class="center">&nbsp;
                                    <asp:LinkButton ID="lnkEdit" runat="server" CommandName="ViewEdit" CommandArgument='<%# Eval("ID") %>' ToolTip="Edit Slider">
                                        <span class="glyphicon iconsweets-create"></span>
                                    </asp:LinkButton>
                                                                &nbsp;&nbsp;&nbsp;
                                    <asp:LinkButton ID="lnkPreview" runat="server" CommandName="DeleteItem" CommandArgument='<%# Eval("ID") %>' ToolTip="Delete Slider">
                                        <span  class="glyphicon glyphicon-remove ColorDelete"></span>
                                    </asp:LinkButton>
                                                            </td>
                                                        </tr>
                                                    </ItemTemplate>
        ...
        <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
            ...
            <div class="alert" id="popup_content">
                <div id="popup_message" style="text-align: center;">Delete Slider Sucessfully</div>
                <div id="popup_panel">
        ...
        $(document).ready(function () {
           var table = $('.dataTables-example').DataTable({
                ...
                buttons: [
                    //{ extend: 'copy' },
                    //{ extend: 'csv' },
                    { extend: 'excel', title: 'Slider', text: '<span class="glyphicon glyphicon-file" style="color:white;padding-right: 4%;"></span> Export to Excel', className: 'btn btn-success btn-Excel', titleAttr: 'Excel' },
                    { extend: 'pdf', title: 'Slider', text: '<span class="glyphicon glyphicon-file" style="color:white;padding-right: 4%;"></span> Export to PDF', className: 'btn btn-success btn-PDF', titleAttr: 'PDF' },
                     { extend: 'print', title: 'Slider', text: '<span class="glyphicon glyphicon-file" style="color:white;padding-right: 4%;"></span> Print', className: 'btn btn-success btn-Print', titleAttr: 'Print' ,
           ...
           $.ajax({
               ...
               url: "ManageSlider.aspx/BindDatatoDropdown",
               data: "{}",
               dataType: "json",
               async: true,
