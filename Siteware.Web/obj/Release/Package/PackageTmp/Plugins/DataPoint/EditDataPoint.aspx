<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditDataPoint.aspx.cs" Inherits="Siteware.Web.Plugins.DataPoint.EditDataPoint" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        <ul class="breadcrumbs">
            ...
            <li><a href="../DataPoint/ManageDataPoint.aspx">DataPoint List</a> <span class="separator"></span></li>
            <li>Edit
                <asp:Label ID="lblTitle" runat="server"></asp:Label></li>
        </ul>

        <div class="pageheader">
            <asp:Button ID="btnAdd2" runat="server" Text="Save" class="btn btn-primary" ValidationGroup="d1" OnClick="BtnAdd_Click"
            ...
            <div class="pagetitle">
                ...
                <h1>Edit
                    <asp:Label ID="lblPageHead" runat="server"></asp:Label></h1>
            </div>
        </div>
                ...
                <div class="row" style="min-height: 456px;">
                    <div class="col-lg-8" style="width: 100%;">
                        <div class="widgetbox personal-information">
                            <div class="tabbedwidget tab-primary" style="min-height: 330px;">
                                ...
                                <div id="a-1" style="min-height: 283px;">
                                    <asp:HiddenField runat="server" ID="lblDataPointID" />
                                    <asp:HiddenField runat="server" ID="lblFocusID" />
                                    <asp:HiddenField runat="server" ID="lblLangID" />
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" InitialValue="0" ErrorMessage="Please Select Language" ID="validLang"
                                            ControlToValidate="ddlLanguages" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="d1" EnableClientScript="True" />
                                    </div>
                                    <div class="form-group" style="height: 42px;display:none">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 15%; padding-left: 1.2%;">Select Entity:</label>
                                        <div class="col-md-10" style="width: 22.9%;">
                                            <asp:DropDownList ID="ddlFocusArea" runat="server" class="chzn-select" TabIndex="2" Width="100%">
                                            </asp:DropDownList>
                                        </div>
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ErrorMessage="Required Field" ID="RequiredFieldValidator3" Style="display: inline;"
                                            ControlToValidate="txtTitle" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="d1" EnableClientScript="True" />
                                    </div>
                                    <div class="form-group" style="height: 42px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 15%; padding-left: 1.2%;">Points:</label>
                                        <div class="col-md-10" style="width: 22.9%;">
                                            <asp:TextBox ID="txtPoints" runat="server" PlaceHolder="Points" class="form-control" MaxLength="20"></asp:TextBox>
                                        </div>
                                        <asp:RequiredFieldValidator runat="server" ErrorMessage="Required Field" ID="RequiredFieldValidator7" Style="display: inline;"
                                            ControlToValidate="txtPoints" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="d1" EnableClientScript="True" />
                                    </div>
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ErrorMessage="Required Field" ID="RequiredFieldValidator5" Style="display: inline;"
                                            ControlToValidate="txtLink" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="d1" EnableClientScript="True" />
                                    </div>
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <div class="col-md-10" style="width: 22%;">
                                            ...
                                            <asp:RequiredFieldValidator runat="server" ErrorMessage="Required Field" ID="RequiredFieldValidator6" Style="display: inline;"
                                                ControlToValidate="ddlParentPage" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="d1" EnableClientScript="True" />
                                        </div>
                                    </div>
                                    <div class="form-group" style="height: 42px">
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ValidationGroup="d1"
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ErrorMessage="Required Field" ID="RequiredFieldValidator1" Style="display: inline;"
                                            ControlToValidate="txtPublishDate" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="d1" EnableClientScript="True" />
                                    </div>
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ErrorMessage="Required Field" ID="RequiredFieldValidator2" Style="display: inline;"
                                            ControlToValidate="txtorderr" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="d1" EnableClientScript="True" />
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" Style="left: 3%; position: relative; color: red;" ValidationGroup="d1"
                        ...
                        <p style="text-align: right;">
                            <asp:Button runat="server" ID="btnAdd" Text="Save" CssClass="btn btn-primary" ValidationGroup="d1" OnClick="BtnAdd_Click" />
                            <%--  <asp:Button ID="BtnAdd" runat="server" Text="Save" class="btn btn-primary" ValidationGroup="d1" OnClick="btnAdd_Click" />--%>
                        </p>
                    </div>
                </div>
                <div class="footer">
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">DataPoint Updated Sucessfully</div>
            <div id="popup_panel">
