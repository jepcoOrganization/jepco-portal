<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AddAboutCompany.aspx.cs" Inherits="Siteware.Web.Plugins.AboutCompany.AddAboutCompany" Async="true"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="rightpanel">
        <ul class="breadcrumbs">
            ...
            <li><a href="ManageCoreValue.aspx">About Company List</a> <span class="separator"></span></li>
            <li>Add New List</li>
        </ul>
                            ...
                            <div class="tabbedwidget tab-primary" style="min-height: 330px;">
                                ...
                                <div id="a-1" style="min-height: 283px;">
                                    ...
                                    <div class="form-group" style="height: 42px">
                                     ...
                                     <div class="form-group" style="height: 42px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 11%; padding-left: 1.2%;">Title 2:</label>
                                        <div class="col-md-10" style="width: 22.9%;">
                                            <asp:TextBox ID="txtTitle2" runat="server" PlaceHolder="Title" class="form-control"></asp:TextBox>
                                        </div>

                                    </div>

                                     <div class="form-group" style="height: 42px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 11%; padding-left: 1.2%;">Title3:</label>
                                        <div class="col-md-10" style="width: 22.9%;">
                                            <asp:TextBox ID="txttitle3" runat="server" PlaceHolder="Title" class="form-control"></asp:TextBox>
                                        </div>
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">Company Information Add Sucessfully</div>
            <div id="popup_panel">
