<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageAboutCompany.aspx.cs" Inherits="Siteware.Web.Plugins.AboutCompany.ManageAboutCompany" Async="true"%>
        ...
        <div class="pageheader">
            <div>
                <asp:LinkButton ID="BtnDelete2" runat="server" class="btn btn-primary" Text="Delete Page" OnClick="BtnDelete2_Click"
                    ...
                    <span class="glyphicon glyphicon-remove" style="color:white;padding-right: 4%;"></span> Delete About Company
                </asp:LinkButton>
                ...
                <asp:LinkButton ID="btnAdd2" runat="server" class="btn btn-primary" Text="Add Pages" OnClick="btnAdd2_Click"
                    ...
                    <span class="glyphicon glyphicon-plus" style="color:white;padding-right: 4%;"></span> Add About Company
                </asp:LinkButton>
            </div>
                                        ...
                                        <table id="mytbl" class="table table-striped table-bordered table-hover dataTables-example">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="head1">Company ID</th>
                                                    <th class="head2">Title</th>   
                                                    <th class="head3">Title2</th>  
                                                    <th class="head9">Title3</th>  
                                            ...
                                            <tbody>
                                                <asp:ListView ID="lstCompany" runat="server" OnItemDataBound="lstCompany_ItemDataBound" OnItemCommand="lstCompany_ItemCommand">
                                                    <ItemTemplate>
                                                        <tr class="gradeX">
                                                            <td class="aligncenter">
                                                                <span class="center">
                                                                    <asp:CheckBox ID="CBID" runat="server" />
                                                                    <asp:Label ID="lblID" runat="server" Text='<%# Bind("CompanyID") %>' Visible="false"></asp:Label>
                                                                </span>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lblCoreID" runat="server" Text='<%# Bind("CompanyID") %>'></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lblTitle" runat="server" Text='<%# Bind("Title") %>'></asp:Label>
                                                            </td>
                                                             <td>
                                                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("Title2") %>'></asp:Label>
                                                            </td>
                                                             <td>
                                                                <asp:Label ID="Label2" runat="server" Text='<%# Bind("Title3") %>'></asp:Label>
                                                            </td>
                                                            ...
                                                            <td class="center">&nbsp;
                                    <asp:LinkButton ID="lnkEdit" runat="server" CommandName="ViewEdit" CommandArgument='<%# Eval("CompanyID") %>' ToolTip="Edit Company">
                                        <span class="glyphicon iconsweets-create"></span>
                                    </asp:LinkButton>
                                                                &nbsp;
                                    <asp:LinkButton ID="lnkDelete" runat="server" CommandName="DeleteItem" CommandArgument='<%# Eval("CompanyID") %>' ToolTip="Delete Company">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                url: "ManageAboutCompany.aspx/BindDatatoDropdown",
                data: "{}",
                dataType: "json",
                async: true,
