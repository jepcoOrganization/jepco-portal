<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AddAnnouncement.aspx.cs" Inherits="Siteware.Web.Plugins.Announcement.AddAnnouncement" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        <ul class="breadcrumbs">
            ...
            <li><a href="ManageAnnouncement.aspx">Announcement List</a> <span class="separator"></span></li>
            <li>Add Announcement List</li>
        </ul>
                        ...
                        <div class="widgetbox personal-information">
                            <div class="tabbedwidget tab-primary" style="min-height: 330px;">
                                <ul>
                                    ...
                                    <li runat="server" id="HeadlineVideo"><a id="LiVideo" href="#a-4" style="font-size: 14px; display: none;">Announcement Video</a></li>
                                    <li runat="server" id="HeadlineImage"><a id="LiImage" href="#a-3" style="font-size: 14px; display: none;">Announcement Image</a></li>
                                </ul>
                                ...
                                <div id="a-4" style="min-height: 283px; display: none;">
                                    <div class="row col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10" style="width: 22.9%;">
                                                <asp:DropDownList class="chzn-select" ClientIDMode="Static" TabIndex="2" Style="width: 210px;" Width="100%" runat="server" ID="ddchoisLink">
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">Announcement Added Sucessfully</div>
            <div id="popup_panel">
