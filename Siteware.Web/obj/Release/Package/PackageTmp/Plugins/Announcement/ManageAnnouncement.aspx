<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageAnnouncement.aspx.cs" Inherits="Siteware.Web.Plugins.Announcement.ManageAnnouncement" Async="true" %>
        ...
        <div class="pageheader">
            <div>
                <asp:LinkButton ID="BtnDelete2" runat="server" class="btn btn-primary" Text="Delete Page" OnClick="BtnDelete2_Click"
                    ...
                    <span class="glyphicon glyphicon-remove" style="color:white;padding-right: 4%;"></span> Delete Announcement
                </asp:LinkButton>
                ...
                <asp:LinkButton ID="btnAdd2" runat="server" class="btn btn-primary" Text="Add Pages" OnClick="btnAdd2_Click"
                    Style="position: relative; float: right; top: 31px; right: 0.5%; color: white">
                    <span class="glyphicon glyphicon-plus" style="color:white;padding-right: 4%;"></span> Add Announcement
                </asp:LinkButton>
            </div>
                                                        ...
                                                        <tr class="gradeX">
                                                            <td class="aligncenter">
                                                                <span class="center">
                                                                    ...
                                                                    <asp:Label ID="lblID" runat="server" Text='<%# Bind("AnnouncementID") %>' Visible="false"></asp:Label>
                                                                </span>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td class="center">&nbsp;
                                    <asp:LinkButton ID="lnkEdit" runat="server" CommandName="ViewEdit" CommandArgument='<%# Eval("AnnouncementID") %>' ToolTip="Edit Announcement">
                                        <span class="glyphicon iconsweets-create"></span>
                                    </asp:LinkButton>
                                                                &nbsp;
                                    <asp:LinkButton ID="lnkDelete" runat="server" CommandName="DeleteItem" CommandArgument='<%# Eval("AnnouncementID") %>' ToolTip="Delete Page">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                url: "ManageAnnouncement.aspx/BindDatatoDropdown",
                data: "{}",
                dataType: "json",
                async: true,
