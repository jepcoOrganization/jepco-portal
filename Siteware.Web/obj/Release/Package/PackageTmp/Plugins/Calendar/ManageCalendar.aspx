<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageCalendar.aspx.cs" Inherits="Siteware.Web.Plugins.Calendar.ManageCalendar" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="pageheader">
            <div>
                <asp:LinkButton ID="BtnDelete2" runat="server" class="btn btn-primary" Text="Delete Page" OnClick="BtnDelete2_Click"
                    ...
                    <span class="glyphicon glyphicon-remove" style="color:white;padding-right: 4%;"></span> Delete Calendar Item
                </asp:LinkButton>
                ...
                <asp:LinkButton ID="btnAdd2" runat="server" class="btn btn-primary" Text="Add Pages" OnClick="btnAdd2_Click"
                    ...
                    <span class="glyphicon glyphicon-plus" style="color:white;padding-right: 4%;"></span> Add Calendar Item
                </asp:LinkButton>
            </div>
                                        ...
                                        <table id="mytbl" class="table table-striped table-bordered table-hover dataTables-example">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="head2">Calendar Name</th>
                                             <%--       <th class="head3">Entity Name</th>--%>
                                                    <th class="head4">LanguageName</th>
                                                    <th class="head5">Event Date</th>
                                            ...
                                            <tbody>
                                                <asp:ListView ID="lstCalendar" runat="server" OnItemDataBound="lstCalendar_ItemDataBound" OnItemCommand="lstCalendar_ItemCommand">
                                                    <ItemTemplate>
                                                        <tr class="gradeX">
                                                            ...
                                                            <td>
                                                                <asp:Label ID="lblCalendarName" runat="server" Text='<%# Bind("CalendarName") %>'></asp:Label>
                                                            </td>
                                                           <%-- <td>
                                                                <asp:Label ID="lblEntityName" runat="server" Text='<%# Bind("EntityName") %>'></asp:Label>
                                                            </td>--%>
                                                            <td>
                                                                <asp:Label ID="lblLanguage" runat="server" Text='<%# Bind("LanguageName") %>'></asp:Label>
                                                            </td>
                                                            <td class="center">
                                                            ...
                                                            <td class="center">&nbsp;
                                    <asp:LinkButton ID="lnkEdit" runat="server" CommandName="ViewEdit" CommandArgument='<%# Eval("ID") %>' ToolTip="Edit Calendar">
                                        <span class="glyphicon iconsweets-create"></span>
                                    </asp:LinkButton>
                                                                &nbsp;
                                    <asp:LinkButton ID="lnkDelete" runat="server" CommandName="DeleteItem" CommandArgument='<%# Eval("ID") %>' ToolTip="Delete Calendar">
                                        <span class="glyphicon glyphicon-remove ColorDelete" style="position: relative;top: 3px;"></span>
                                    </asp:LinkButton>
                                                                &nbsp;
                                    <asp:LinkButton ID="lnkEvents" runat="server" CommandName="EventsItem" CommandArgument='<%# Eval("ID") %>' ToolTip="Event">
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">Event Information Delete Sucessfully</div>
            <div id="popup_panel">
    ...
    <cc1:ModalPopupExtender ID="mpeSuccess2" runat="server" CancelControlID="butCancel"
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                url: "ManageCalendar.aspx/BindDatatoDropdown",
                data: "{}",
                dataType: "json",
                async: true,
