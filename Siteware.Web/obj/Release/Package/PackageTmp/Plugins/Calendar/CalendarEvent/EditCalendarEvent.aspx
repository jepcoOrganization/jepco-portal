<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditCalendarEvent.aspx.cs" Inherits="Siteware.Web.Plugins.Calendar.CalendarEvent.EditCalendarEvent" Async="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            // Tags Input
            jQuery('.timepickerrr').timepicker();
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        <ul class="breadcrumbs">
            ...
            <li><a href="ManageCalendarEvent.aspx">Event List</a> <span class="separator"></span></li>
            <li>Edit
                <asp:Label ID="lblCalendarEventName1" runat="server"></asp:Label>
                Item</li>
        </ul>
        ...
        <div class="pageheader">
            ...
            <div class="pagetitle">
                ...
                <h1>Edit
                    <asp:Label ID="lblCalendaEventrName2" runat="server"></asp:Label>
                    Item</h1>
            </div>
        </div>
                    ...
                    <div class="col-lg-8" style="width: 100%;">
                        <div class="widgetbox personal-information">
                            <div class="tabbedwidget tab-primary" style="min-height: 330px;">
                                <ul>
                                    <li><a href="#a-1" style="font-size: 14px;">Event Information</a></li>
                                    <li><a href="#a-2" style="font-size: 14px;">Content HTML</a></li>
                                    <li><a href="#a-3" style="font-size: 14px;">Map Event</a></li>
                                </ul>
                                <div id="a-1" style="min-height: 283px;">
                                    <div class="form-group" style="height: 42px">
                                        <asp:HiddenField runat="server" ID="lblEventID" />
                                        <asp:HiddenField runat="server" ID="lblLangID" />
                                        <label class="col-md-2 control-label" style="text-align: left; width: 11%; padding-left: 1.2%;">Event Title:</label>
                                        <div class="col-md-10" style="width: 23.9%;">
                                            <asp:TextBox ID="txtEventTitle" runat="server" PlaceHolder="Event Title" class="form-control"></asp:TextBox>
                                        </div>
                                        <asp:RequiredFieldValidator runat="server" ErrorMessage="Please Fill Date" ID="RequiredFieldValidator2"
                                            ControlToValidate="txtEventTitle" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="1" EnableClientScript="True" />
                                    </div>
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" InitialValue="0" ErrorMessage="Please Select Entity" ID="RequiredFieldValidator3"
                                    ...
                                    <div class="form-group" style="height: 61px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 11%; padding-left: 1.2%;">Event Summary:</label>
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 11%; padding-left: 1.2%;">Event URL:</label>
                                        <div class="col-md-10" style="width: 23.9%;">
                                            <asp:TextBox ID="txtEventURL" runat="server" PlaceHolder="Event URL" class="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group" style="height: 42px">
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 11%; padding-left: 1.2%;">Event Time:</label>
                                        <div class="col-md-10" style="width: 23.9%;">
                                            <div class="input-group bootstrap-timepicker" style="width: 100%;">
                                                <input id="txtEventTime" runat="server" type="text" class="timepickerrr form-control" />
                                            </div>
                                            <asp:RequiredFieldValidator runat="server" ErrorMessage="Please Fill Date" ID="RequiredFieldValidator1"
                                                ControlToValidate="txtEventTime" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="1" EnableClientScript="True" />
                                        </div>
                                    </div>
                                    <div class="form-group" style="height: 42px">
                                ...
                                <div id="a-2" style="min-height: 283px;">
                                    <CKEditor:CKEditorControl ID="txtDescirption" runat="server"></CKEditor:CKEditorControl>
                                </div>
                                <div id="a-3" style="min-height: 283px;">
                                    <div class="form-group" style="height: 42px">
                                        <asp:Label runat="server" class="col-md-2 control-label" ID="lblMapEvent1" Style="text-align: left; width: 15%; padding-left: 1.2%; font-weight: bold">
                                            Map Event:
                                        </asp:Label>
                                        <div class="col-md-10" style="width: 45%;">
                                            <asp:DropDownList ID="ddlMappedEvent1" runat="server" class="chzn-select" TabIndex="2" Width="100%">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">Event Information Update Sucessfully</div>
            <div id="popup_panel">
