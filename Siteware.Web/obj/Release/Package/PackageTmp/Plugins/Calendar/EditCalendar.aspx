<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditCalendar.aspx.cs" Inherits="Siteware.Web.Plugins.Calendar.EditCalendar" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        <ul class="breadcrumbs">
            ...
            <li>Edit
                <asp:Label ID="lblCalendarName1" runat="server"></asp:Label>
                Item</li>
        </ul>
        ...
        <div class="pageheader">
            ...
            <div class="pagetitle">
                ...
                <h1>Edit
                    <asp:Label ID="lblCalendarName2" runat="server"></asp:Label>
                    Item</h1>
            </div>
        </div>
                    ...
                    <div class="col-lg-8" style="width: 100%;">
                        <div class="widgetbox personal-information">
                            ...
                            <div class="widgetcontent form-horizontal">
                                <asp:HiddenField runat="server" ID="hdnCalID" />
                                <asp:HiddenField runat="server" ID="hdnEntityID" />
                                <asp:HiddenField runat="server" ID="hdnLangID" />
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">Calendar Information Update Sucessfully</div>
            <div id="popup_panel">
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">Can't Update Please Check Event Date</div>
            <div id="popup_panel">
