<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AddServiceNote.aspx.cs" Inherits="Siteware.Web.Plugins.ServiceNote.AddServiceNote" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        <ul class="breadcrumbs">
            ...
            <li><a href="ManageServiceNote.aspx">ServiceNote List</a> <span class="separator"></span></li>
            <li>Add ServiceNote List</li>
        </ul>
                    ...
                    <div class="col-lg-8" style="width: 100%;">
                        <div class="widgetbox personal-information">
                            <div class="tabbedwidget tab-primary" style="min-height: 330px;">
                                <ul>
                                    <li><a href="#a-1" style="font-size: 14px;">Service Note Information</a></li>
                                    <li><a href="#a-2" style="font-size: 14px;">Contact Details </a></li>
                                </ul>
                               <br />
                                <div id="a-1" style="min-height: 283px;">
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 15%; padding-left: 1.2%;">Title2:</label>
                                        <div class="col-md-10" style="width: 22.9%;">
                                            <asp:TextBox ID="txtTitle2" runat="server" PlaceHolder="Title2" Style="width: 273px;" class="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <%--<div class="form-group" style="height: 42px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 15%; padding-left: 1.2%;">Contact Details:</label>
                                        <div class="col-md-10" style="width: 22.9%;">
                                            <asp:TextBox ID="txtContactDetail" runat="server" PlaceHolder="Contact Details" Style="width: 273px;" class="form-control"></asp:TextBox>
                                        </div>
                                    </div>--%>
                                    <div class="form-group" style="height: 42px">
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">Service Note Added Sucessfully</div>
            <div id="popup_panel">
