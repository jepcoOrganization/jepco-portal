<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageServiceNote.aspx.cs" Inherits="Siteware.Web.Plugins.ServiceNote.ManageServiceNote" Async="true" %>
                                                        ...
                                                        <tr class="gradeX">
                                                            <td class="aligncenter">
                                                                <span class="center">
                                                                    ...
                                                                    <asp:Label ID="lblID" runat="server" Text='<%# Bind("ServiceNoteID") %>' Visible="false"></asp:Label>
                                                                </span>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lblServiceNoteID" runat="server" Text='<%# Bind("ServiceNoteID") %>'></asp:Label>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td class="center">&nbsp;
                                    <asp:LinkButton ID="lnkEdit" runat="server" CommandName="ViewEdit" CommandArgument='<%# Eval("ServiceNoteID") %>' ToolTip="Edit ServiceNote">
                                        <span class="glyphicon iconsweets-create"></span>
                                    </asp:LinkButton>
                                                                &nbsp;
                                    <asp:LinkButton ID="lnkDelete" runat="server" CommandName="DeleteItem" CommandArgument='<%# Eval("ServiceNoteID") %>' ToolTip="Delete ServiceNote">
