<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditProfile.aspx.cs" Inherits="Siteware.Web.EditProfile.EditProfile" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        ...
        <div class="pageheader">
            ...
            <asp:Button ID="btnUpdate2" runat="server" Text="Save" class="btn btn-primary" ValidationGroup="1" OnClick="btnUpdate_Clicks"
                ...
                <div class="row">
                        ...
                        <div class="widgetbox login-information">
                            <div class="tabbedwidget tab-primary" style="min-height: 229px;">
                                <ul>
                                    ...
                                    <li><a href="#a-2" style="font-size: 14px;">Change Password</a></li>
                                </ul>
                                    ...
                                    <div>
                                        ...
                                        <div class="input-group" style="width: 82%; float: right;">
                                            <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server"
                                                    ...
                                                    ValidationGroup="1"
                                                    Display="Dynamic"
                                                    Style="color: Red; float: right; position: relative; right: 4%;margin-right: -2%;"></asp:RequiredFieldValidator>--%>
                    ...
                    <div class="col-lg-8" style="width: 100%;">
                                ...
                                <div class="form-group">
                                   ...
                                   <div class="form-group" style="height: 42px">                                    
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ValidationGroup="1"
                                            ErrorMessage="Please enter date in mm/dd/yyyy format" ControlToValidate="datepicker" ForeColor="Red"
                                         ...
                                         <asp:RequiredFieldValidator runat="server" ErrorMessage="Please Fill Date" ID="RequiredFieldValidator4"
                                            ControlToValidate="datepicker" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="1" EnableClientScript="True" />
                                    </div>
                            ...
                            <div class="widgetcontent form-horizontal">
                                <div class="form-group">
                                    <label class="col-md-2 control-label" style="text-align: left; width: 10%; padding-left: 1.2%;">Hire Date:</label>
                                     <div class="col-md-10" style="width: 23.9%;">
                                            <input id="datepicker2" runat="server" type="text" placeholder="mm/dd/yyyy" name="date" class="Dateeee form-control" />
                                        </div>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ValidationGroup="1"
                                            ErrorMessage="Please enter date in mm/dd/yyyy format" ControlToValidate="datepicker2" ForeColor="Red"
                                            ValidationExpression="(0[1-9]|1[012])/(0[1-9]|[12][0-9]|3[01])/\d{4}"></asp:RegularExpressionValidator>
                                         <asp:RequiredFieldValidator runat="server" ErrorMessage="Please Fill Date" ID="RequiredFieldValidator1"
                                            ControlToValidate="datepicker2" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="1" EnableClientScript="True" />
                        ...
                        <p style="text-align: right;">
                            <asp:Button ID="btnUpdate" runat="server" Text="Save" class="btn btn-primary"  OnClick="btnUpdate_Clicks" />
                        </p>
                    </div>
                </div>
