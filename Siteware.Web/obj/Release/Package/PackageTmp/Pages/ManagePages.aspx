<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManagePages.aspx.cs" Inherits="Siteware.Web.Pages.ManagePages" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        ...
        <div class="pageheader">
            <div>
                <asp:LinkButton ID="BtnDelete2" runat="server" class="btn btn-primary" Text="Delete Page" OnClick="BtnDelete2_Click"
                    ...
                    <span class="glyphicon glyphicon-remove" style="color:white;padding-right: 4%;"></span> Delete Page
                </asp:LinkButton>
       <%--         <asp:LinkButton ID="BtnPDF2" runat="server" class="btn btn-danger" Text="Export to PDF"
                ...
                <asp:LinkButton ID="btnAdd2" runat="server" class="btn btn-primary" Text="Add Page" OnClick="btnAdd_Click"
                    Style="position: relative; float: right; top: 31px; right: 0.5%; color: white">
                    <span class="glyphicon glyphicon-plus" style="color:white;padding-right: 4%;"></span> Add Page
                </asp:LinkButton>
            </div>
                                        ...
                                        <table id="mytbl" class="table table-striped table-bordered table-hover dataTables-example">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="head1">Page ID</th>
                                                    <th class="head2">Page name</th>
                                                    <th class="head3">Description Page</th>
                                                    <%--<th class="head0">Last Modified Date</th>--%>
                                                    <th class="head4">Language</th>
                                                    <th class="head5">Physical Path</th>
                                                    <th class="head6">Publish Date</th>
                                                    <th class="head7">Is Publish</th>
                                                    <th class="head8">View Count</th>
                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="gradeX">
                                                            <td class="aligncenter">
                                                                <span class="center">
                                                                    <%--<input id="CheckBoxID" runat="server" type="checkbox" value='<%# Eval("PageID") %>' />--%>
                                                                    <asp:CheckBox ID="CBID" runat="server" />
                                                                    <asp:Label ID="lblID" runat="server" Text='<%# Bind("PageID") %>' Visible="false"></asp:Label>                                                                    
                                                                </span>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <asp:Label ID="lblPageName" runat="server" Text='<%# Bind("Name") %>'></asp:Label>
                                                            </td>
                                                            <td class="center">
                                                                <asp:Label ID="lblIsDeleted" runat="server" Text='<%# Bind("Description") %>'></asp:Label>
                                                            </td>
                                                            <%--                                <td>
                                    <asp:Label ID="lblPageURL" runat="server" Text='<%# Bind("PageURL") %>'></asp:Label>
                                </td>--%>
                                                            <%--<td class="center">
                                    <asp:Label ID="lblEditDate" runat="server" Text='<%# Bind("EditDate") %>'></asp:Label>
                                </td>--%>
                                                            <td class="center">
                                                                <asp:Label ID="lblLang" runat="server" Text='<%# Bind("LanguageName") %>'></asp:Label>                                                                
                                                            </td>
                                                              <td class="center">
                                                                  <asp:HyperLink runat="server" ID="lnkPath" Text='<%# Bind("AliasPath") %>' Target="_blank" NavigateUrl='<%# Bind("AliasPath") %>'></asp:HyperLink>                                                               
                                                            </td>
                                                            <td class="center">
                                                            ...
                                                            <td class="center">
                                                                <asp:Label ID="lblPageCount" runat="server" Text='<%# Bind("ViewCount") %>'></asp:Label>
                                                            </td>

                                                            <td class="center">&nbsp;
                                    <asp:LinkButton ID="lnkEdit" runat="server" CommandName="ViewEdit" CommandArgument='<%# Eval("PageID") %>' ToolTip="Edit Page">
                                        <span class="glyphicon iconsweets-create"></span>
                                    </asp:LinkButton>
                              <%--                                  &nbsp;
                                    <asp:LinkButton ID="lnkPreview" runat="server" CommandName="Preview" CommandArgument='<%# Eval("PageID") %>' ToolTip="Preview Page">
                                        <span class="glyphicon iconsweets-preview"></span>
                                    </asp:LinkButton>--%>
                                                                &nbsp;
                                    <asp:LinkButton ID="lnkDelete" runat="server" CommandName="DeleteItem" CommandArgument='<%# Eval("PageID") %>' ToolTip="Delete Page">
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            ...
            <div id="popup_panel">
                 <asp:Button ID="butOk" runat="server" Text="Ok" OnClick="btnOk_Click" Style="color: #3b6c8e; border: 2px solid #3b6c8e; padding: 7px 0; background: #fff;" />
...
<%--        <div id="popup_container1" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        <h1 style="cursor: move;" id="popup_title1">Delete Status</h1>
        <div class="alert" id="popup_content1">
            <div id="popup_message1" style="text-align: center;">Are you sure to Delete Item</div>
            <div id="popup_panel1">
    ...
    <cc1:ModalPopupExtender ID="ModalPopupExtender1" runat="server"
        ...
        BehaviorID="ModalPopupExtender1" CancelControlID="butCancel"
        ...
        $(document).ready(function () {            
          ...
          var table = $('.dataTables-example').DataTable({
                ...
                buttons: [
                    //{ extend: 'copy' },
                    //{ extend: 'csv' },
                    { extend: 'excel', title: 'Pages', className: 'btn btn-success btn-Excel', titleAttr: 'Excel' },
                    { extend: 'pdf', title: 'Pages', className: 'btn btn-success btn-PDF', titleAttr: 'PDF' },
                     {
                         extend: 'print', title: 'Pages', className: 'btn btn-success btn-Print', titleAttr: 'Print',
          ...
          $.ajax({
              ...
              url: "ManagePages.aspx/BindDatatoDropdown",
              data: "{}",
              dataType: "json",
              async: true,
