<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AddSetting.aspx.cs" Inherits="Siteware.Web.Setting.AddSetting" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="col-lg-8" style="width: 100%;">
                        <div class="widgetbox personal-information">
                            <div class="tabbedwidget tab-primary" style="min-height: 330px;">
                               <%-- <ul>
                                    <li><a href="#a-1" style="font-size: 14px;">Setting Information</a></li>
                                    <li id="HeadlineImage" runat="server"><a href="#a-2" style="font-size: 14px;">Logo</a></li>
                                    <li><a href="#a-3" style="font-size: 14px;">SMTP Server</a></li>
                                    <li><a href="#a-5" style="font-size: 14px;">Admin Email Content</a></li>
                                    <li><a href="#a-6" style="font-size: 14px;">User Email Content</a></li>
                                    <li><a href="#a-4" class="clickMeta" style="font-size: 14px;">Copyright</a></li>

                                    <li><a href="#a-7" style="font-size: 14px;">Renewable Device Admin Email</a></li>
                                    <li><a href="#a-8" style="font-size: 14px;">Renewable Device User Email</a></li>
                                    
                                    <li><a href="#a-9" style="font-size: 14px;">Renewable SolarCell Admin Email</a></li>
                                    <li><a href="#a-10" style="font-size: 14px;">Renewable SolarCell User Email</a></li>
                                    
                                    <li><a href="#a-11" style="font-size: 14px;">Renewable Registration Admin Email</a></li>
                                    <li><a href="#a-12" style="font-size: 14px;">Renewable Registration User Email</a></li>
                                ...
                                <div id="a-1" style="min-height: 283px;">
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        ...
                                        <div class="col-md-10" style="width: 22%;">
                                            ...
                                            <asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="Required" ClientValidationFunction = "ValidateCheckBox" EnableClientScript="True" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="1"></asp:CustomValidator>
                                             <script type = "text/javascript">
                                                 function ValidateCheckBox(sender, args) {
                                                     if (document.getElementById("<%=CBIsPublished.ClientID %>").checked == true) {
                                                         args.IsValid = true;
                                                     } else {
                                                         args.IsValid = false;
                                                     }
                                            ...
                                            <%--OnCheckedChanged="CBIsPublished_CheckedChanged" AutoPostBack="true"--%>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="a-3" style="min-height: 283px;">
                                    <div class="form-group" style="height: 42px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 11%; padding-left: 1.2%;">SMTP Server:</label>
                                        <div class="col-md-10" style="width: 22.9%;">
                                    ...
                                    <div class="form-group" style="height: 42px">
                                        <label class="col-md-2 control-label" style="text-align: left; width: 11%; padding-left: 1.2%;">Password:</label>
                                        <div class="col-md-10" style="width: 22.9%;">
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">Setting Information Add Sucessfully</div>
            <div id="popup_panel">
