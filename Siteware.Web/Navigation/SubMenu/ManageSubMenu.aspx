<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageSubMenu.aspx.cs" Inherits="Siteware.Web.Navigation.SubMenu.ManageSubMenu" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="pageheader">
            <div>
                <asp:LinkButton ID="BtnDelete2" runat="server" class="btn btn-primary" Text="Delete Page" OnClick="BtnDelete2_Click"
                    ...
                    <span class="glyphicon glyphicon-remove" style="color:white;padding-right: 4%;"></span> Delete Sub Menu Item
                </asp:LinkButton>
             <%--   <asp:LinkButton ID="BtnPDF2" runat="server" class="btn btn-danger" Text="Export to PDF"
                ...
                <asp:LinkButton ID="btnAdd2" runat="server" class="btn btn-primary" Text="Add Pages" OnClick="btnAdd2_Click"
                    Style="position: relative; float: right; top: 31px; right:0.5%; color: white">
                    <span class="glyphicon glyphicon-plus" style="color:white;padding-right: 4%;"></span> Add Sub Menu Item
                </asp:LinkButton>
            </div>
                                        ...
                                        <table id="mytbl" class="table table-striped table-bordered table-hover dataTables-example">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="head1">Sub Menu Name</th>
                                                    <th class="head2">Sub Menu URL</th>
                                                    <th class="head3">Language</th>
                                                    <th class="head4">Open In</th>
                                            ...
                                            <tbody>
                                                <asp:ListView ID="lstSubMenu" runat="server" OnItemDataBound="lstSubMenu_ItemDataBound" OnItemCommand="lstSubMenu_ItemCommand">
                                                    <ItemTemplate>
                                                        <tr class="gradeX">
                                                            ...
                                                            <td class="center">&nbsp;
                                    <asp:LinkButton ID="lnkEdit" runat="server" CommandName="ViewEdit" CommandArgument='<%# Eval("ID") %>' ToolTip="Edit Sub Menu">
                                        <span class="glyphicon iconsweets-create"></span>
                                    </asp:LinkButton>
                                                                &nbsp;
                                    <asp:LinkButton ID="lnkDelete" runat="server" CommandName="DeleteItem" CommandArgument='<%# Eval("ID") %>' ToolTip="Delete Sub Menu">
                                        <span class="glyphicon glyphicon-remove ColorDelete" style="position: relative;top: 3px;"></span>
                                    </asp:LinkButton>
                                                                &nbsp;
                                    <asp:LinkButton ID="lnkMoveSubMenu" runat="server" CommandName="MoveSubMenu" CommandArgument='<%# Eval("ID") %>' ToolTip="Move Sub Menu">
                                        <span class="glyphicon glyphicon-move" style="color: gray;position: relative;top: 3px;"></span>
                                    </asp:LinkButton>
                                                            </td>
                                                        </tr>
                                                    </ItemTemplate>
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            ...
            <div id="popup_panel">
                <asp:Button ID="btnOk222" runat="server" Text="Ok" OnClick="btnOk_Click111" Style="color: #3b6c8e; border: 2px solid #3b6c8e; padding: 7px 0; background: #fff;" />
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        <h1 style="cursor: move;" id="popup_title">Move Status</h1>
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">
                <div class="form-group">
                    <label class="col-md-2 control-label" style="text-align: left; width: 40%; padding-left: 1.2%;">Parent Menu:</label>
                    <div class="col-md-10" style="width: 58.9%;">
            ...
            <div id="popup_panel">
                <asp:Button ID="btnChangeParent" runat="server" Text="Ok" OnClick="btnChangeParent_Click" Style="color: #3b6c8e; border: 2px solid #3b6c8e; padding: 7px 0; background: #fff;" />
    ...
    <cc1:ModalPopupExtender ID="mpeSuccess2" runat="server"
        ...
        PopupControlID="popup_container" CancelControlID="btnCancel">
    </cc1:ModalPopupExtender>
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">Sub Menu Information Update Sucessfully</div>
            <div id="popup_panel">
    ...
    <cc1:ModalPopupExtender ID="mpeSucces3" runat="server"
        TargetControlID="lblpopup3"
        BehaviorID="mpeSucces3"
        BackgroundCssClass="modalBackground"
        PopupControlID="popup_container">
    </cc1:ModalPopupExtender>
    <asp:Label runat="server" ID="lblpopup3"></asp:Label>
    ...
    <script>
        ...
        $(document).ready(function () {
           ...
           $.ajax({
               ...
               url: "ManageSubMenu.aspx/BindDatatoDropdown",
               data: "{}",
               dataType: "json",
               async: true,
