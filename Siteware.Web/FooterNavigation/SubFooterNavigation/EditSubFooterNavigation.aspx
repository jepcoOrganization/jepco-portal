<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditSubFooterNavigation.aspx.cs" Inherits="Siteware.Web.FooterNavigation.SubFooterNavigation.EditSubFooterNavigation" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="rightpanel">
        <ul class="breadcrumbs">
            ...
            <li>Edit
                <asp:Label ID="lblMenuFootername1" runat="server"></asp:Label>
                List</li>
        </ul>

        <div class="pageheader">
            <asp:Button ID="btnAdd2" runat="server" Text="Save" class="btn btn-primary" ValidationGroup="f2" OnClick="btnAdd2_Click"
            ...
            <div class="pagetitle">
                ...
                <h1>Edit &nbsp;
                    <asp:Label ID="lblMenuFootername2" runat="server"></asp:Label></h1>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-8" style="width: 100%;">
                            ...
                            <div class="widgetcontent form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator runat="server"  ErrorMessage="Required Field" ID="RequiredFieldValidator1"
                                                ControlToValidate="txtTitle" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="f2" EnableClientScript="True" />
                                </div>
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator runat="server"  ErrorMessage="Required Field" ID="RequiredFieldValidator3"
                                                ControlToValidate="txtURL" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="f2" EnableClientScript="True" />
                                </div>
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator runat="server"  ErrorMessage="Required Field" ID="RequiredFieldValidator2"
                                                ControlToValidate="txtMenuOrder" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="f2" EnableClientScript="True" />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ValidationGroup="f2"
                                    ...
                                    <asp:RequiredFieldValidator runat="server" ErrorMessage="Please Fill Date" ID="RequiredFieldValidator4"
                                        ControlToValidate="txtPublishDate" Display="Dynamic" Text="Required Field" ForeColor="Red" ValidationGroup="f2" EnableClientScript="True" />
                                </div>
                                <div class="form-group">
                        ...
                        <p style="text-align: right;">
                            <asp:Button ID="BtnAdd" runat="server" Text="Save" class="btn btn-primary" ValidationGroup="f2" OnClick="btnAdd2_Click" />
                        </p>
                    </div>
                </div>
    ...
    <div id="popup_container" class="ui-draggable" style="display: none; position: fixed; z-index: 99999; padding: 0px; margin: 0px; min-width: 300px; max-width: 300px; top: 35.5px; left: 524.5px;">
        ...
        <div class="alert" id="popup_content">
            <div id="popup_message" style="text-align: center;">SubMenu Footer Information Update Sucessfully</div>
            <div id="popup_panel">
