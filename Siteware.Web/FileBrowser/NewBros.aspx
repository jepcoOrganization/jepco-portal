<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewBros.aspx.cs" Inherits="MB.FileBrowser.NewBros" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            <iz:FileManager ID="FileManager1" runat="server" Height="480" Width="570" ImagesFolder="~/FileBrowser/img/cmd"
                MainDirectory="~/Siteware/Siteware_File" CustomThumbnailHandler="~/FileBrowser/IZWebFileManagerThumbnailHandler.ashx"
                ShowHiddenFilesAndFolders="true"  AllowUpload="true" AllowOverwrite="true" AllowDelete="true" FileViewMode="Thumbnails" ClientOpenItemFunction="fileSelected"
            ...
            <asp:Panel ID="Panel_deny" runat="server" CssClass="alert alert-danger" Style="background-color: #ebeadb;display:none;
border-color: #ebeadb;" Visible="false">
            </asp:Panel>
        </div>
                ...
                callbacks: {                    
                    ...
                    onComplete: function (id, fileName, responseJSON) {                        
                        if (responseJSON.success) {
                            ...
                            bootbox.alert('Upload errore: ' + responseJSON.msg);
                        }
                        $fileview.spin(false);
                    }
                }
...
<%--    <style>
        #FileManager1_FileViewCMDRename{
