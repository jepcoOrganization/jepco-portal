...
{
    public partial class NewBros : System.Web.UI.Page, System.Web.UI.ICallbackEventHandler
    { 
            ...
            protected void Page_Load(object sender, EventArgs e)
            {
                if (SessionManager.GetInstance.Users != null)
                {
                    ...
                    FlashFolder = (!String.IsNullOrEmpty(HF_FileBrowserConfig.Attributes["data-flashfolder"]) ?
                            HF_FileBrowserConfig.Attributes["data-flashfolder"] : "Video");
                    ...
                    if (!IsPostBack)
                    {
                        ...
                        string type = "";
                        string mainRoot = "~/Siteware/Siteware_File"; //"~/Siteware_File";
                    ...
                    if (FileManager1.Culture == null)
                        ...
                        DND_message.InnerText = FileManager1.Controller.GetResourceString("Upload_dnd", "Or drag and drop one or more files on the above area");
                        ...
                        if (UseDefaultRoots)
                        {
                            ...
                            switch (type)
                            {
                                ...
                                case "flash":
                                    ...
                                    flash.Text = FileManager1.Controller.GetResourceString("Root_Flash", "Video");
