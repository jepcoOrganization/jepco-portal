                       ...
                       <div class="row" id="otharAddRow_1">
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                <div class="form-group">
                                    ...
                                    <label>المعدات الأخرى التي سيتم استخدامها </label>                                    
                                    <input type="text" id="txtOtherDevice_1" name="txtOtherDevice_1" style="display: none">
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-3">
...
<script type="text/javascript">
   ...
   <%-- function CloseDevicePopup() {
    ...
    function GetOthersNewRow() {
        ...
        arrayOthersCount.push(MeterRowCount);
        //GetDeviceData(DeViceCount);

        OthersRowCount = OthersRowCount + 1;

        $("#<%=HdnMeterStatus.ClientID%>").val(OthersRowCount.toString());
